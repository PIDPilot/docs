...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Eeedwx_e.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CUlrL_qo.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "docs";
var SERVER_FN_BASE = "/docs/_serverFn/";
