...
var Route$t = class Route extends BaseRoute {
  /**
...
const THEME_STORAGE_KEY = "pid-pilot-theme";
...
`;
const appCss = "/docs/assets/styles-B6Mb2GEI.css";
...
const Route$s = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "PID Pilot is a drop-in PIDF tuning library for FTC with one-button relay auto-tune for flywheels, arms, and elevators — live on FTC Dashboard."
      },
      { name: "author", content: "PID Pilot" },
      { property: "og:title", content: "PID Pilot" },
      {
        property: "og:description",
        content: "Drop-in PIDF tuning library for FTC with one-button relay auto-tune for velocity and position mechanisms."
      },
...
const $$splitComponentImporter$r = () => import("./tuner-lab-CEIyZhaU.js");
const Route$r = createFileRoute("/tuner-lab")({
  head: () => ({
    meta: [{
      title: "PID Pilot — Framework Lab"
    }, {
      name: "description",
      content: "Interactive guide to how PID Pilot’s velocity and position frameworks change between REV_UP and MAINTAIN."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$r, "component")
});
const $$splitComponentImporter$q = () => import("./docs-CboGYRFG.js");
const Route$q = createFileRoute("/docs")({
  component: lazyRouteComponent($$splitComponentImporter$q, "component")
});
const $$splitComponentImporter$p = () => import("./index-CZ9w_i9J.js");
const Route$p = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "PID Pilot is a drop-in PIDF tuning library for FTC. Point it at a flywheel, arm, or elevator and its relay auto-tune computes working gains — one OpMode, one button, live on FTC Dashboard."
    }, {
      property: "og:title",
      content: "PID Pilot — Auto-Tuned PIDF for FTC"
    }, {
      property: "og:description",
      content: "Relay auto-tune computes working PIDF gains for any FTC mechanism. Add one Gradle dependency, run one OpMode."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$p, "component")
});
const $$splitComponentImporter$o = () => import("./docs.index-Mt-ov0RD.js");
const Route$o = createFileRoute("/docs/")({
  head: () => ({
    meta: [{
      title: "Introduction — PID Pilot"
    }, {
      name: "description",
      content: "PID Pilot is a drop-in PIDF tuning library for FTC with one-button relay auto-tune for flywheels, arms, and elevators."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$o, "component")
});
const $$splitComponentImporter$n = () => import("./docs.troubleshooting-Bqr0R6au.js");
const Route$n = createFileRoute("/docs/troubleshooting")({
  head: () => ({
    meta: [{
      title: "Troubleshooting — PID Pilot"
    }, {
      name: "description",
      content: "Troubleshoot common PID Pilot issues in velocity and position sessions using the framework’s real diagnostics and caveats."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$n, "component")
});
const $$splitComponentImporter$m = () => import("./docs.templates-CGgwEW0j.js");
const Route$m = createFileRoute("/docs/templates")({
  head: () => ({
    meta: [{
      title: "Sample OpModes — PID Pilot"
    }, {
      name: "description",
      content: "Ready-to-copy velocity, arm, and elevator tuning OpModes for PID Pilot, using relay auto-tune by default."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$m, "component")
});
const $$splitComponentImporter$l = () => import("./docs.quick-start-Bdb_wQFa.js");
const Route$l = createFileRoute("/docs/quick-start")({
  head: () => ({
    meta: [{
      title: "Quick Start — PID Pilot"
    }, {
      name: "description",
      content: "Get relay auto-tune running on an FTC mechanism in a few minutes: extend PIDFTunerOpMode, return a Config, press start."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$l, "component")
});
const $$splitComponentImporter$k = () => import("./docs.installation-BVHh9V9M.js");
const Route$k = createFileRoute("/docs/installation")({
  head: () => ({
    meta: [{
      title: "Installation — PID Pilot"
    }, {
      name: "description",
      content: "Add PID Pilot to your FTC project as a JitPack Gradle dependency and prepare FTC Dashboard for live tuning."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$k, "component")
});
const $$splitComponentImporter$j = () => import("./docs.velocity.refinement-SzpiuC0N.js");
const Route$j = createFileRoute("/docs/velocity/refinement")({
  head: () => ({
    meta: [{
      title: "Velocity Running Control & Headroom — PID Pilot"
    }, {
      name: "description",
      content: "How VelocityPIDFTuner runs closed-loop control, enforces motor mode, manages target ramping, and warns about unrealistic gains."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$j, "component")
});
const $$splitComponentImporter$i = () => import("./docs.velocity.overview-B0YpgpE6.js");
const Route$i = createFileRoute("/docs/velocity/overview")({
  head: () => ({
    meta: [{
      title: "Velocity Tuner Overview — PID Pilot"
    }, {
      name: "description",
      content: "Overview of VelocityPIDFTuner, its raw ticks-per-second model, lifecycle phases, and operational responsibilities."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("./docs.velocity.ku-search-Cs-Zvf7N.js");
const Route$h = createFileRoute("/docs/velocity/ku-search")({
  head: () => ({
    meta: [{
      title: "Velocity Relay Auto-Tuning — PID Pilot"
    }, {
      name: "description",
      content: "How VelocityPIDFTuner uses a hysteretic relay to estimate Ku, Pu, and conservative starting gains."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("./docs.velocity.f-sweep-CSzWSAA4.js");
const Route$g = createFileRoute("/docs/velocity/f-sweep")({
  head: () => ({
    meta: [{
      title: "Velocity Characterization & Feedforward — PID Pilot"
    }, {
      name: "description",
      content: "How VelocityPIDFTuner characterizes max velocity, computes physical kF, and chooses a feedforward source."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$g, "component")
});
const $$splitComponentImporter$f = () => import("./docs.velocity.disruption-D7BPrqiq.js");
const Route$f = createFileRoute("/docs/velocity/disruption")({
  head: () => ({
    meta: [{
      title: "Velocity Disruption Sampling — PID Pilot"
    }, {
      name: "description",
      content: "How the velocity tuner measures disturbance recovery when MAINTAIN behavior matters more than raw spin-up."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$f, "component")
});
const $$splitComponentImporter$e = () => import("./docs.velocity.config-C1ojGs_c.js");
const Route$e = createFileRoute("/docs/velocity/config")({
  head: () => ({
    meta: [{
      title: "Velocity Config Reference — PID Pilot"
    }, {
      name: "description",
      content: "Reference for VelocityPIDFTuner.Config, including feedforward sources, relay tuning, disruption settings, and validation rules."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./docs.reference.telemetry-LLkfJv1A.js");
const Route$d = createFileRoute("/docs/reference/telemetry")({
  head: () => ({
    meta: [{
      title: "Telemetry & Final Summary — PID Pilot"
    }, {
      name: "description",
      content: "How PID Pilot uses telemetry as a diagnostic surface across the base runner, controller core, velocity tuner, and position tuner."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./docs.reference.setup-rules-DB-0Un-D.js");
const Route$c = createFileRoute("/docs/reference/setup-rules")({
  head: () => ({
    meta: [{
      title: "Setup Rules — PID Pilot"
    }, {
      name: "description",
      content: "Hard setup rules for using PID Pilot safely and in ways that match the framework’s control model."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./docs.reference.practical-notes-C1_yc2AM.js");
const Route$b = createFileRoute("/docs/reference/practical-notes")({
  head: () => ({
    meta: [{
      title: "Workflows & Caveats — PID Pilot"
    }, {
      name: "description",
      content: "Practical engineering workflows, tuner differences, extension points, and real-world caveats for PID Pilot."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./docs.reference.faq-DUfpBUmJ.js");
const Route$a = createFileRoute("/docs/reference/faq")({
  head: () => ({
    meta: [{
      title: "FAQ — PID Pilot"
    }, {
      name: "description",
      content: "Frequently asked questions about PID Pilot’s tuning modes, feedforward semantics, motor ownership, and supported actuator workflows."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./docs.position.refinement-DLO6ftvc.js");
const Route$9 = createFileRoute("/docs/position/refinement")({
  head: () => ({
    meta: [{
      title: "Position Bounds & Control Flow — PID Pilot"
    }, {
      name: "description",
      content: "How PositionPIDFTuner applies bounds, qualifies at-target state, and executes its closed-loop update path."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./docs.position.overview-CSJHpaJg.js");
const Route$8 = createFileRoute("/docs/position/overview")({
  head: () => ({
    meta: [{
      title: "Position Tuner Overview — PID Pilot"
    }, {
      name: "description",
      content: "Overview of PositionPIDFTuner, including actuator families, normalized control, motion profiles, feedforward, and bounds."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./docs.position.ku-search-DSuY19_H.js");
const Route$7 = createFileRoute("/docs/position/ku-search")({
  head: () => ({
    meta: [{
      title: "Position Motion Profile & Feedforward — PID Pilot"
    }, {
      name: "description",
      content: "How PositionPIDFTuner uses move normalization, optional trapezoidal motion profiles, and layered feedforward terms."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./docs.position.hold-f-zpqJjoDa.js");
const Route$6 = createFileRoute("/docs/position/hold-f")({
  head: () => ({
    meta: [{
      title: "Position Actuator & Feedback Modes — PID Pilot"
    }, {
      name: "description",
      content: "How PositionPIDFTuner supports motors, CR servos, standard servos, and multiple feedback sources."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./docs.position.disturbance-DRLLvPDP.js");
const Route$5 = createFileRoute("/docs/position/disturbance")({
  head: () => ({
    meta: [{
      title: "Position Disruption Sampling — PID Pilot"
    }, {
      name: "description",
      content: "How PositionPIDFTuner measures hold robustness after a push or load change and when disruption logic is unavailable."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./docs.position.config-DzaEjVdB.js");
const Route$4 = createFileRoute("/docs/position/config")({
  head: () => ({
    meta: [{
      title: "Position Config Reference — PID Pilot"
    }, {
      name: "description",
      content: "Reference for PositionPIDFTuner.Config, covering actuator families, feedback modes, motion profiles, feedforward, bounds, and validation."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./docs.position.auto-tune-_CkfqKQP.js");
const Route$3 = createFileRoute("/docs/position/auto-tune")({
  head: () => ({
    meta: [{
      title: "Position Auto-Tune — PID Pilot"
    }, {
      name: "description",
      content: "How relay auto-tune finds kP/kI/kD for arms, elevators, and slides driven by motors or CR servos."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./docs.concepts.tuning-modes-BWwByz7x.js");
const Route$2 = createFileRoute("/docs/concepts/tuning-modes")({
  head: () => ({
    meta: [{
      title: "Tuning Modes — PID Pilot"
    }, {
      name: "description",
      content: "How PID Pilot uses REV_UP and MAINTAIN as separate controller personalities with separate gains."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./docs.concepts.scoring-C4RxhbKc.js");
const Route$1 = createFileRoute("/docs/concepts/scoring")({
  head: () => ({
    meta: [{
      title: "How Auto-Tune Works — PID Pilot"
    }, {
      name: "description",
      content: "The relay (Åström–Hägglund) method behind PID Pilot's auto-tune: how it measures a mechanism and turns that into PIDF gains."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./docs.concepts.pidf-terms-C5YOKJYd.js");
const Route2 = createFileRoute("/docs/concepts/pidf-terms")({
  head: () => ({
    meta: [{
      title: "Shared Concepts — PID Pilot"
    }, {
      name: "description",
      content: "Shared control concepts in PID Pilot: feedforward vs feedback, Dashboard-driven config, telemetry, and controller internals."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const TunerLabRoute = Route$r.update({
  id: "/tuner-lab",
  path: "/tuner-lab",
  getParentRoute: () => Route$s
});
const DocsRoute = Route$q.update({
  id: "/docs",
  path: "/docs",
  getParentRoute: () => Route$s
});
...
const DocsIndexRoute = Route$o.update({
  id: "/",
  path: "/",
  getParentRoute: () => DocsRoute
});
const DocsTroubleshootingRoute = Route$n.update({
  id: "/troubleshooting",
  path: "/troubleshooting",
  getParentRoute: () => DocsRoute
});
const DocsTemplatesRoute = Route$m.update({
  id: "/templates",
  path: "/templates",
  getParentRoute: () => DocsRoute
});
const DocsQuickStartRoute = Route$l.update({
  id: "/quick-start",
  path: "/quick-start",
  getParentRoute: () => DocsRoute
});
const DocsInstallationRoute = Route$k.update({
  id: "/installation",
  path: "/installation",
  getParentRoute: () => DocsRoute
});
const DocsVelocityRefinementRoute = Route$j.update({
  id: "/velocity/refinement",
  path: "/velocity/refinement",
  getParentRoute: () => DocsRoute
});
const DocsVelocityOverviewRoute = Route$i.update({
  id: "/velocity/overview",
  path: "/velocity/overview",
  getParentRoute: () => DocsRoute
});
const DocsVelocityKuSearchRoute = Route$h.update({
  id: "/velocity/ku-search",
  path: "/velocity/ku-search",
  getParentRoute: () => DocsRoute
});
const DocsVelocityFSweepRoute = Route$g.update({
  id: "/velocity/f-sweep",
  path: "/velocity/f-sweep",
  getParentRoute: () => DocsRoute
});
const DocsVelocityDisruptionRoute = Route$f.update({
  id: "/velocity/disruption",
  path: "/velocity/disruption",
  getParentRoute: () => DocsRoute
});
const DocsVelocityConfigRoute = Route$e.update({
  id: "/velocity/config",
  path: "/velocity/config",
  getParentRoute: () => DocsRoute
});
const DocsReferenceTelemetryRoute = Route$d.update({
  id: "/reference/telemetry",
  path: "/reference/telemetry",
  getParentRoute: () => DocsRoute
});
const DocsReferenceSetupRulesRoute = Route$c.update({
  id: "/reference/setup-rules",
  path: "/reference/setup-rules",
  getParentRoute: () => DocsRoute
});
const DocsReferencePracticalNotesRoute = Route$b.update({
  id: "/reference/practical-notes",
  path: "/reference/practical-notes",
  getParentRoute: () => DocsRoute
});
const DocsReferenceFaqRoute = Route$a.update({
  id: "/reference/faq",
  path: "/reference/faq",
  getParentRoute: () => DocsRoute
});
const DocsPositionRefinementRoute = Route$9.update({
  id: "/position/refinement",
  path: "/position/refinement",
  getParentRoute: () => DocsRoute
});
const DocsPositionOverviewRoute = Route$8.update({
  id: "/position/overview",
  path: "/position/overview",
  getParentRoute: () => DocsRoute
});
const DocsPositionKuSearchRoute = Route$7.update({
  id: "/position/ku-search",
  path: "/position/ku-search",
  getParentRoute: () => DocsRoute
});
const DocsPositionHoldFRoute = Route$6.update({
  id: "/position/hold-f",
  path: "/position/hold-f",
  getParentRoute: () => DocsRoute
});
const DocsPositionDisturbanceRoute = Route$5.update({
  id: "/position/disturbance",
  path: "/position/disturbance",
  getParentRoute: () => DocsRoute
});
const DocsPositionConfigRoute = Route$4.update({
  id: "/position/config",
  path: "/position/config",
  getParentRoute: () => DocsRoute
});
const DocsPositionAutoTuneRoute = Route$3.update({
  id: "/position/auto-tune",
  path: "/position/auto-tune",
  getParentRoute: () => DocsRoute
});
const DocsConceptsTuningModesRoute = Route$2.update({
  id: "/concepts/tuning-modes",
  path: "/concepts/tuning-modes",
  getParentRoute: () => DocsRoute
});
const DocsConceptsScoringRoute = Route$1.update({
  id: "/concepts/scoring",
  path: "/concepts/scoring",
  getParentRoute: () => DocsRoute
});
const DocsConceptsPidfTermsRoute = Route2.update({
...
const DocsRouteChildren = {
  ...
  DocsIndexRoute,
  DocsConceptsPidfTermsRoute,
  DocsConceptsScoringRoute,
  DocsConceptsTuningModesRoute,
  DocsPositionAutoTuneRoute,
  DocsPositionConfigRoute,
  DocsPositionDisturbanceRoute,
  DocsPositionHoldFRoute,
  DocsPositionKuSearchRoute,
  DocsPositionOverviewRoute,
  DocsPositionRefinementRoute,
  DocsReferenceFaqRoute,
  DocsReferencePracticalNotesRoute,
  DocsReferenceSetupRulesRoute,
  DocsReferenceTelemetryRoute,
  DocsVelocityConfigRoute,
  DocsVelocityDisruptionRoute,
  DocsVelocityFSweepRoute,
  DocsVelocityKuSearchRoute,
  DocsVelocityOverviewRoute,
  DocsVelocityRefinementRoute
};
...
export {
  Link as L,
  THEME_STORAGE_KEY as T,
  applyTheme as a,
  getDocumentTheme as g,
  router as r
};
