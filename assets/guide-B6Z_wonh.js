import{u as We,a as He,b as Ke,r as v,j as u,L as M,O as $e}from"./index-Bu1DThJ5.js";import{l as Ye}from"./pidpilot-logo-transparent-ByPRmtFM.js";import{u as Qe,c as ie,T as Xe}from"./ThemeToggle-BH2DWyZf.js";import{c as A}from"./createLucideIcon-DRgSxJox.js";import{S as Je}from"./SiteFooter-B8wMe2iz.js";import{u as Ze,P as re,a as en,c as nn,b as tn,d as on,e as rn}from"./index-DzYdWh3p.js";function sn(n){const e=We();return He(e.stores.location,Ke(n,e))}const an=[["path",{d:"M7 7h10v10",key:"1tivn9"}],["path",{d:"M7 17 17 7",key:"1vkiza"}]],ln=A("arrow-up-right",an);const cn=[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]],dn=A("chevron-down",cn);const un=[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]],ge=A("chevron-right",un);const hn=[["path",{d:"m15 10 5 5-5 5",key:"qqa56n"}],["path",{d:"M4 4v7a4 4 0 0 0 4 4h12",key:"z08zvw"}]],pn=A("corner-down-right",hn);const mn=[["path",{d:"M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z",key:"1oefj6"}],["path",{d:"M14 2v5a1 1 0 0 0 1 1h5",key:"wfsgrz"}],["path",{d:"M10 9H8",key:"b1mrlr"}],["path",{d:"M16 13H8",key:"t4e002"}],["path",{d:"M16 17H8",key:"z1uh3a"}]],gn=A("file-text",mn);const fn=[["line",{x1:"4",x2:"20",y1:"9",y2:"9",key:"4lhtct"}],["line",{x1:"4",x2:"20",y1:"15",y2:"15",key:"vyu0kd"}],["line",{x1:"10",x2:"8",y1:"3",y2:"21",key:"1ggp8o"}],["line",{x1:"16",x2:"14",y1:"3",y2:"21",key:"weycgp"}]],yn=A("hash",fn);const bn=[["path",{d:"M4 5h16",key:"1tepv9"}],["path",{d:"M4 12h16",key:"1lakjw"}],["path",{d:"M4 19h16",key:"1djgab"}]],vn=A("menu",bn);const kn=[["path",{d:"m21 21-4.34-4.34",key:"14j7rj"}],["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}]],fe=A("search",kn);const wn=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],De=A("x",wn);function Re(n){return"links"in n}const Ae=[{title:"Getting Started",links:[{title:"Introduction",to:"/guide"},{title:"Installation",to:"/guide/installation"},{title:"Quick Start",to:"/guide/quick-start"},{title:"Sample OpModes",to:"/guide/templates"}]},{title:"Concepts",links:[{title:"PIDF Terms",to:"/guide/concepts/pidf-terms"},{title:"REV_UP vs MAINTAIN",to:"/guide/concepts/tuning-modes"},{title:"How Auto-Tune Works",to:"/guide/concepts/scoring"}]},{title:"Velocity — Flywheels",links:[{title:"Overview",to:"/guide/velocity/overview"},{title:"Auto-Tune (Relay)",to:"/guide/velocity/ku-search"},{title:"Config Reference",to:"/guide/velocity/config"},{title:"Advanced",links:[{title:"Feedforward Characterization",to:"/guide/velocity/f-sweep"},{title:"Running Control & Headroom",to:"/guide/velocity/refinement"},{title:"Disruption Sampling",to:"/guide/velocity/disruption"}]}]},{title:"Position — Arms & Slides",links:[{title:"Overview",to:"/guide/position/overview"},{title:"Auto-Tune (Relay)",to:"/guide/position/auto-tune"},{title:"Config Reference",to:"/guide/position/config"},{title:"Advanced",links:[{title:"Actuator & Feedback Modes",to:"/guide/position/hold-f"},{title:"Motion Profile & Feedforward",to:"/guide/position/ku-search"},{title:"Bounds & Control Flow",to:"/guide/position/refinement"},{title:"Disruption Sampling",to:"/guide/position/disturbance"}]}]},{title:"Reference",links:[{title:"Using Your Gains in Production",to:"/guide/reference/production-code"},{title:"Troubleshooting",to:"/guide/troubleshooting"},{title:"Telemetry & Final Summary",to:"/guide/reference/telemetry"},{title:"Workflows & Caveats",to:"/guide/reference/practical-notes"},{title:"Setup Rules",to:"/guide/reference/setup-rules"},{title:"FAQ",to:"/guide/reference/faq"}]}],L=Ae.flatMap(n=>n.links.flatMap(e=>Re(e)?e.links.map(t=>({...t,section:`${n.title} / ${e.title}`})):[{...e,section:n.title}])),xn=`import { createFileRoute } from "@tanstack/react-router";
...
`,Dn=`import { createFileRoute, Link } from "@tanstack/react-router";
import { CodeBlock } from "@/components/CodeBlock";
...
`,Rn=`import { createFileRoute } from "@tanstack/react-router";
import { CodeBlock } from "@/components/CodeBlock";
...
`,An=`import { createFileRoute } from "@tanstack/react-router";
...
`,En=`import { createFileRoute } from "@tanstack/react-router";
import { CodeBlock } from "@/components/CodeBlock";
...
`,Nn=`import { createFileRoute, Link } from "@tanstack/react-router";
import { CodeBlock } from "@/components/CodeBlock";
...
`,Ln=`import { createFileRoute, Link } from "@tanstack/react-router";
import { CodeBlock } from "@/components/CodeBlock";

export const Route = createFileRoute("/guide/reference/production-code")({
  head: () => ({
    meta: [
      { title: "Using Your Gains in Production — PID Pilot" },
      {
        name: "description",
        content:
          "How to apply the kP/kI/kD/kF that PID Pilot computes to real FTC competition code — shooter (velocity) and slide (position) examples using PIDFController.",
      },
    ],
  }),
  component: Page,
...
function Page() {
  return (
    <>
      <h1>Using Your Gains in Production</h1>
      <p>
        The tuning OpMode gets you numbers. To actually run a mechanism in a match you reuse the
        framework&apos;s <code>PIDFController</code> in your own loop. That matters: the gains were
        fit to <em>this</em> control law, so they transfer cleanly here — but{" "}
        <strong>not</strong> into <code>setVelocityPIDFCoefficients()</code> or{" "}
        <code>RUN_TO_POSITION</code>, which use a different formulation and units.
      </p>

      <blockquote>
        The Tuner&apos;s <Link to="/tuner">Script Builder</Link> emits this production code for you —
        pick <strong>Production code</strong> above the generated snippet. The examples below explain
        what it does.
      </blockquote>

      <h2>The control law</h2>
      <p>Every loop, the controller computes a motor power from your gains:</p>
      <CodeBlock
        filename="control law"
        language="java"
        code={\`output = kP·(target − meas)
...
output = clamp(output, −1, +1)        // motor power\`}
      />
      <p>
        You feed it <code>(target, measurement, dt)</code> and apply the returned power. For velocity
        the feedforward <code>kF·target</code> does most of the work; for position it&apos;s usually
        zero and gravity is added separately.
      </p>

      <h2>Dual-wheel shooter (velocity)</h2>
      <p>
        Read the average <em>absolute</em> velocity of the two wheels (the same measurement the tuner
        used), and drive both motors with the controller output. Run the motors in{" "}
        <code>RUN_WITHOUT_ENCODER</code> so the SDK&apos;s built-in velocity PID doesn&apos;t fight
        yours.
      </p>
      <CodeBlock
...
public class Shooter extends OpMode {
    ...
    @Override public void loop() {
      ...
      <h2>Position slide (arm / elevator)</h2>
      <p>
        Same idea, but the measurement is <code>getCurrentPosition()</code> and you add a gravity
        feedforward. For a vertical slide that&apos;s a constant hold power (<code>kG</code>); for an
        arm it&apos;s <code>kCos·cos(angle)</code>.
      </p>
      <CodeBlock
        filename="Slide.java"
        language="java"
...
public class Slide extends OpMode {
    ...
    @Override public void loop() {
      ...
      <ul>
        <li>
          <strong>
            <code>RUN_WITHOUT_ENCODER</code>
          </strong>{" "}
          on the controlled motor — otherwise the SDK&apos;s own PID fights yours.{" "}
          <code>getVelocity()</code> / <code>getCurrentPosition()</code> still read the encoder in
          that mode.
        </li>
        <li>
          <strong>
            <code>dt</code> in seconds
          </strong>
          , reset every loop. The controller clamps a tiny first <code>dt</code>.
        </li>
        <li>
          <strong>
            <code>pidf.reset()</code>
          </strong>{" "}
          whenever you disable output, so the integral doesn&apos;t wind up.
        </li>
        <li>
          <strong>Match your tuned setup</strong> — same motor directions and the same measurement
          (average <code>|velocity|</code> for opposed shooter wheels).
        </li>
        <li>
          <strong>Position <code>kF</code> stays 0</strong> — here <code>fTerm = kF·target</code>, so
          it is not a gravity term. Add a constant <code>kG</code> (or <code>kCos·cos(angle)</code>)
          for gravity instead.
        </li>
        <li>
          <strong>Don&apos;t</strong> paste these gains into <code>setVelocityPIDFCoefficients()</code>{" "}
          — different formula, different scaling; they won&apos;t behave the same.
        </li>
      </ul>

      <h2>Other actuators</h2>
      <ul>
        <li>
          <strong>CR servos (position):</strong> identical to the slide, but read position from the
          feedback encoder and call <code>crServo.setPower(power)</code>.
        </li>
        <li>
          <strong>Open-loop standard servos:</strong> no PID — map the target range linearly to{" "}
          <code>setPosition(0..1)</code>. The builder emits this directly.
        </li>
        <li>
          <strong>Closed-loop standard servos:</strong> the firmware already closes an inner loop, so
          faithful outer-loop control is mechanism-specific — keep the framework&apos;s controller for
          these rather than hand-rolling it.
        </li>
      </ul>

      <blockquote>
        Keeping the gains as <code>@Config</code> static fields lets you nudge them live from FTC
        Dashboard during a practice match — the same workflow you used while tuning. See{" "}
        <Link to="/guide/reference/telemetry">Telemetry &amp; Final Summary</Link> for where to read
        the computed values.
      </blockquote>
    </>
  );
...
`,jn=`import { createFileRoute } from "@tanstack/react-router";
import { CodeBlock } from "@/components/CodeBlock";
...
protected PositionPIDFTuner.Config configurePosition() {
    ...
    return new PositionPIDFTuner.Config()
      ...
      <p>
        Once you&apos;ve run one of these and read the computed gains, see{" "}
        <Link to="/guide/reference/production-code">Using Your Gains in Production</Link> for the
        matching competition code — or just let the{" "}
        <Link to="/tuner">Script Builder</Link> emit both the tuning OpMode and the production
        OpMode for you.
      </p>
    </>
  );
}
`,Un=`import { createFileRoute, Link } from "@tanstack/react-router";
...
`,Hn=`import { createFileRoute } from "@tanstack/react-router";
import { CodeBlock } from "@/components/CodeBlock";
...
`,Kn=`import { createFileRoute, Link } from "@tanstack/react-router";
...
`,Yn=Object.assign({"../routes/guide.concepts.pidf-terms.tsx":xn,"../routes/guide.concepts.scoring.tsx":Tn,"../routes/guide.concepts.tuning-modes.tsx":Pn,"../routes/guide.index.tsx":In,"../routes/guide.installation.tsx":Cn,"../routes/guide.position.auto-tune.tsx":Dn,"../routes/guide.position.config.tsx":Rn,"../routes/guide.position.disturbance.tsx":An,"../routes/guide.position.hold-f.tsx":Mn,"../routes/guide.position.ku-search.tsx":_n,"../routes/guide.position.overview.tsx":Fn,"../routes/guide.position.refinement.tsx":En,"../routes/guide.quick-start.tsx":Nn,"../routes/guide.reference.faq.tsx":Sn,"../routes/guide.reference.practical-notes.tsx":On,"../routes/guide.reference.production-code.tsx":Ln,"../routes/guide.reference.setup-rules.tsx":Bn,"../routes/guide.reference.telemetry.tsx":jn,"../routes/guide.templates.tsx":Vn,"../routes/guide.troubleshooting.tsx":Un,"../routes/guide.tsx":qn,"../routes/guide.velocity.config.tsx":zn,"../routes/guide.velocity.disruption.tsx":Gn,"../routes/guide.velocity.f-sweep.tsx":Wn,"../routes/guide.velocity.ku-search.tsx":Hn,"../routes/guide.velocity.overview.tsx":Kn,"../routes/guide.velocity.refinement.tsx":$n});function Qn(n){return n==="/guide"?"../routes/guide.index.tsx":`../routes/guide.${n.replace(/^\/guide\//,"").replaceAll("/",".")}.tsx`}function Xn(n){return n.match(/function Page\(\)\s*\{[\s\S]*?return\s*\(([\s\S]*?)\);\s*\}/)?.[1]??n}function Jn(n){return n.replace(/\s+/g," ").trim()}function Y(n){return Jn(n.replace(/<CodeBlock[\s\S]*?code=\{`([\s\S]*?)`\}[\s\S]*?\/>/g," $1 ").replace(/\{\s*" "\s*\}/g," ").replace(/\{\s*' '\s*\}/g," ").replace(/\{"([^"]*?)"\}/g," $1 ").replace(/\{'([^']*?)'\}/g," $1 ").replace(/\{\/\*[\s\S]*?\*\/\}/g," ").replace(/\{[\s\S]*?\}/g," ").replace(/<[^>]+>/g," "))}function Me(n){return n.toLowerCase().replace(/&amp;/g,"and").replace(/[^a-z0-9\s-]/g,"").trim().replace(/\s+/g,"-").replace(/-+/g,"-")}function Zn(n,e){const t=Me(n)||"section",i=e.get(t)??0;return e.set(t,i+1),i===0?t:`${t}-${i+1}`}function et(n){const e=[...n.matchAll(/<(h[1-3])>([\s\S]*?)<\/\1>/g)].map(i=>({end:(i.index??0)+i[0].length,index:i.index??0,level:Number(i[1].slice(1)),title:Y(i[2])})),t=new Map;return e.filter(i=>!!i.title).map((i,o,r)=>{const s=r[o+1],a=Y(n.slice(i.end,s?.index??n.length));return{...i,anchor:Zn(i.title,t),content:a}})}function nt(n){return[...n.matchAll(/<CodeBlock\b/g)].length}function tt(n){const e=Yn[Qn(n.to)]??"",t=Xn(e),i=et(t);return{...n,content:Y(t),codeSnippetCount:nt(t),headings:i.filter(o=>o.level===2||o.level===3)}}const se=L.map(tt),ot=se.flatMap(n=>[{content:n.content,id:`${n.to}#page`,section:n.section,title:n.title,to:n.to},...n.headings.map(e=>({anchor:e.anchor,content:e.content,heading:e.title,headingLevel:e.level,id:`${n.to}#${e.anchor}`,section:n.section,title:n.title,to:n.to}))]);function _(n){return Array.isArray?Array.isArray(n):Fe(n)==="[object Array]"}function it(n){if(typeof n=="string")return n;if(typeof n=="bigint")return n.toString();const e=n+"";return e=="0"&&1/n==-1/0?"-0":e}function Q(n){return n==null?"":it(n)}function x(n){return typeof n=="string"}function z(n){return typeof n=="number"}function rt(n){return n===!0||n===!1||st(n)&&Fe(n)=="[object Boolean]"}function _e(n){return typeof n=="object"}function st(n){return _e(n)&&n!==null}function P(n){return n!=null}function q(n){return!n.trim().length}function Fe(n){return n==null?n===void 0?"[object Undefined]":"[object Null]":Object.prototype.toString.call(n)}const at="Incorrect 'index' type",lt=n=>`Invalid value for key ${n}`,ct=n=>`Pattern length exceeds max of ${n}.`,dt=n=>`Missing ${n} property in key`,ut=n=>`Property 'weight' in key '${n}' must be a positive integer`,ye=Object.prototype.hasOwnProperty;class ht{constructor(e){this._keys=[],this._keyMap={};let t=0;e.forEach(i=>{const o=Ee(i);this._keys.push(o),this._keyMap[o.id]=o,t+=o.weight}),this._keys.forEach(i=>{i.weight/=t})}get(e){return this._keyMap[e]}keys(){return this._keys}toJSON(){return JSON.stringify(this._keys)}}function Ee(n){let e=null,t=null,i=null,o=1,r=null;if(x(n)||_(n))i=n,e=be(n),t=X(n);else{if(!ye.call(n,"name"))throw new Error(dt("name"));const s=n.name;if(i=s,ye.call(n,"weight")&&(o=n.weight,o<=0))throw new Error(ut(s));e=be(s),t=X(s),r=n.getFn}return{path:e,id:t,weight:o,src:i,getFn:r}}function be(n){return _(n)?n:n.split(".")}function X(n){return _(n)?n.join("."):n}function pt(n,e){const t=[];let i=!1;const o=(r,s,a,c)=>{if(P(r))if(!s[a])t.push(c!==void 0?{v:r,i:c}:r);else{const d=s[a],l=r[d];if(!P(l))return;if(a===s.length-1&&(x(l)||z(l)||rt(l)||typeof l=="bigint"))t.push(c!==void 0?{v:Q(l),i:c}:Q(l));else if(_(l)){i=!0;for(let p=0,m=l.length;p<m;p+=1)o(l[p],s,a+1,p)}else s.length&&o(l,s,a+1,c)}};return o(n,x(e)?e.split("."):e,0),i?t:t[0]}const mt={includeMatches:!1,findAllMatches:!1,minMatchCharLength:1},gt={isCaseSensitive:!1,ignoreDiacritics:!1,includeScore:!1,keys:[],shouldSort:!0,sortFn:(n,e)=>n.score===e.score?n.idx<e.idx?-1:1:n.score<e.score?-1:1},ft={location:0,threshold:.6,distance:100},yt={useExtendedSearch:!1,useTokenSearch:!1,getFn:pt,ignoreLocation:!1,ignoreFieldNorm:!1,fieldNormWeight:1},g=Object.freeze({...gt,...mt,...ft,...yt}),bt=/[^ ]+/g;function vt(n=1,e=3){const t=new Map,i=Math.pow(10,e);return{get(o){const r=o.match(bt).length;if(t.has(r))return t.get(r);const s=1/Math.pow(r,.5*n),a=parseFloat(Math.round(s*i)/i);return t.set(r,a),a},clear(){t.clear()}}}class ae{constructor({getFn:e=g.getFn,fieldNormWeight:t=g.fieldNormWeight}={}){this.norm=vt(t,3),this.getFn=e,this.isCreated=!1,this.docs=[],this.keys=[],this._keysMap={},this.setIndexRecords()}setSources(e=[]){this.docs=e}setIndexRecords(e=[]){this.records=e}setKeys(e=[]){this.keys=e,this._keysMap={},e.forEach((t,i)=>{this._keysMap[t.id]=i})}create(){this.isCreated||!this.docs.length||(this.isCreated=!0,x(this.docs[0])?this.docs.forEach((e,t)=>{this._addString(e,t)}):this.docs.forEach((e,t)=>{this._addObject(e,t)}),this.norm.clear())}add(e){const t=this.size();x(e)?this._addString(e,t):this._addObject(e,t)}removeAt(e){this.records.splice(e,1);for(let t=e,i=this.size();t<i;t+=1)this.records[t].i-=1}removeAll(e){for(let t=e.length-1;t>=0;t-=1)this.records.splice(e[t],1);for(let t=0,i=this.records.length;t<i;t+=1)this.records[t].i=t}getValueForItemAtKeyId(e,t){return e[this._keysMap[t]]}size(){return this.records.length}_addString(e,t){if(!P(e)||q(e))return;const i={v:e,i:t,n:this.norm.get(e)};this.records.push(i)}_addObject(e,t){const i={i:t,$:{}};this.keys.forEach((o,r)=>{const s=o.getFn?o.getFn(e):this.getFn(e,o.path);if(P(s)){if(_(s)){const a=[];for(let c=0,d=s.length;c<d;c+=1){const l=s[c];if(P(l)){if(x(l)){if(!q(l)){const p={v:l,i:c,n:this.norm.get(l)};a.push(p)}}else if(P(l.v)){const p=x(l.v)?l.v:Q(l.v);if(!q(p)){const m={v:p,i:l.i,n:this.norm.get(p)};a.push(m)}}}}i.$[r]=a}else if(x(s)&&!q(s)){const a={v:s,n:this.norm.get(s)};i.$[r]=a}}}),this.records.push(i)}toJSON(){return{keys:this.keys.map(({getFn:e,...t})=>t),records:this.records}}}function Ne(n,e,{getFn:t=g.getFn,fieldNormWeight:i=g.fieldNormWeight}={}){const o=new ae({getFn:t,fieldNormWeight:i});return o.setKeys(n.map(Ee)),o.setSources(e),o.create(),o}function kt(n,{getFn:e=g.getFn,fieldNormWeight:t=g.fieldNormWeight}={}){const{keys:i,records:o}=n,r=new ae({getFn:e,fieldNormWeight:t});return r.setKeys(i),r.setIndexRecords(o),r}function wt(n=[],e=g.minMatchCharLength){const t=[];let i=-1,o=-1,r=0;for(let s=n.length;r<s;r+=1){const a=n[r];a&&i===-1?i=r:!a&&i!==-1&&(o=r-1,o-i+1>=e&&t.push([i,o]),i=-1)}return n[r-1]&&r-i>=e&&t.push([i,r-1]),t}const S=32;function xt(n,e,t,{location:i=g.location,distance:o=g.distance,threshold:r=g.threshold,findAllMatches:s=g.findAllMatches,minMatchCharLength:a=g.minMatchCharLength,includeMatches:c=g.includeMatches,ignoreLocation:d=g.ignoreLocation}={}){if(e.length>S)throw new Error(ct(S));const l=e.length,p=n.length,m=Math.max(0,Math.min(i,p));let h=r,y=m;const f=(T,R)=>{const C=T/l;if(d)return C;const B=Math.abs(m-R);return o?C+B/o:B?1:C},b=a>1||c,w=b?Array(p):[];let k;for(;(k=n.indexOf(e,y))>-1;){const T=f(0,k);if(h=Math.min(T,h),y=k+l,b){let R=0;for(;R<l;)w[k+R]=1,R+=1}}y=-1;let I=[],N=1,V=l+p;const Ge=1<<l-1;for(let T=0;T<l;T+=1){let R=0,C=V;for(;R<C;)f(T,m+C)<=h?R=C:V=C,C=Math.floor((V-R)/2+R);V=C;let B=Math.max(1,m-C+1);const $=s?p:Math.min(m+C,p)+l,O=Array($+2);O[$+1]=(1<<T)-1;for(let D=$;D>=B;D-=1){const U=D-1,me=t[n[U]];if(b&&(w[U]=+!!me),O[D]=(O[D+1]<<1|1)&me,T&&(O[D]|=(I[D+1]|I[D])<<1|1|I[D+1]),O[D]&Ge&&(N=f(T,U),N<=h)){if(h=N,y=U,y<=m)break;B=Math.max(1,2*m-y)}}if(f(T+1,m)>h)break;I=O}const K={isMatch:y>=0,score:Math.max(.001,N)};if(b){const T=wt(w,a);T.length?c&&(K.indices=T):K.isMatch=!1}return K}function Tt(n){const e={};for(let t=0,i=n.length;t<i;t+=1){const o=n.charAt(t);e[o]=(e[o]||0)|1<<i-t-1}return e}function le(n){if(n.length<=1)return n;n.sort((t,i)=>t[0]-i[0]||t[1]-i[1]);const e=[n[0]];for(let t=1,i=n.length;t<i;t+=1){const o=e[e.length-1],r=n[t];r[0]<=o[1]+1?o[1]=Math.max(o[1],r[1]):e.push(r)}return e}const Se={ł:"l",Ł:"L",đ:"d",Đ:"D",ø:"o",Ø:"O",ħ:"h",Ħ:"H",ŧ:"t",Ŧ:"T",ı:"i",ß:"ss"},Pt=new RegExp("["+Object.keys(Se).join("")+"]","g"),j=String.prototype.normalize?n=>n.normalize("NFD").replace(/[\u0300-\u036F\u0483-\u0489\u0591-\u05BD\u05BF\u05C1\u05C2\u05C4\u05C5\u05C7\u0610-\u061A\u064B-\u065F\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7\u06E8\u06EA-\u06ED\u0711\u0730-\u074A\u07A6-\u07B0\u07EB-\u07F3\u07FD\u0816-\u0819\u081B-\u0823\u0825-\u0827\u0829-\u082D\u0859-\u085B\u08D3-\u08E1\u08E3-\u0903\u093A-\u093C\u093E-\u094F\u0951-\u0957\u0962\u0963\u0981-\u0983\u09BC\u09BE-\u09C4\u09C7\u09C8\u09CB-\u09CD\u09D7\u09E2\u09E3\u09FE\u0A01-\u0A03\u0A3C\u0A3E-\u0A42\u0A47\u0A48\u0A4B-\u0A4D\u0A51\u0A70\u0A71\u0A75\u0A81-\u0A83\u0ABC\u0ABE-\u0AC5\u0AC7-\u0AC9\u0ACB-\u0ACD\u0AE2\u0AE3\u0AFA-\u0AFF\u0B01-\u0B03\u0B3C\u0B3E-\u0B44\u0B47\u0B48\u0B4B-\u0B4D\u0B56\u0B57\u0B62\u0B63\u0B82\u0BBE-\u0BC2\u0BC6-\u0BC8\u0BCA-\u0BCD\u0BD7\u0C00-\u0C04\u0C3E-\u0C44\u0C46-\u0C48\u0C4A-\u0C4D\u0C55\u0C56\u0C62\u0C63\u0C81-\u0C83\u0CBC\u0CBE-\u0CC4\u0CC6-\u0CC8\u0CCA-\u0CCD\u0CD5\u0CD6\u0CE2\u0CE3\u0D00-\u0D03\u0D3B\u0D3C\u0D3E-\u0D44\u0D46-\u0D48\u0D4A-\u0D4D\u0D57\u0D62\u0D63\u0D82\u0D83\u0DCA\u0DCF-\u0DD4\u0DD6\u0DD8-\u0DDF\u0DF2\u0DF3\u0E31\u0E34-\u0E3A\u0E47-\u0E4E\u0EB1\u0EB4-\u0EB9\u0EBB\u0EBC\u0EC8-\u0ECD\u0F18\u0F19\u0F35\u0F37\u0F39\u0F3E\u0F3F\u0F71-\u0F84\u0F86\u0F87\u0F8D-\u0F97\u0F99-\u0FBC\u0FC6\u102B-\u103E\u1056-\u1059\u105E-\u1060\u1062-\u1064\u1067-\u106D\u1071-\u1074\u1082-\u108D\u108F\u109A-\u109D\u135D-\u135F\u1712-\u1714\u1732-\u1734\u1752\u1753\u1772\u1773\u17B4-\u17D3\u17DD\u180B-\u180D\u1885\u1886\u18A9\u1920-\u192B\u1930-\u193B\u1A17-\u1A1B\u1A55-\u1A5E\u1A60-\u1A7C\u1A7F\u1AB0-\u1ABE\u1B00-\u1B04\u1B34-\u1B44\u1B6B-\u1B73\u1B80-\u1B82\u1BA1-\u1BAD\u1BE6-\u1BF3\u1C24-\u1C37\u1CD0-\u1CD2\u1CD4-\u1CE8\u1CED\u1CF2-\u1CF4\u1CF7-\u1CF9\u1DC0-\u1DF9\u1DFB-\u1DFF\u20D0-\u20F0\u2CEF-\u2CF1\u2D7F\u2DE0-\u2DFF\u302A-\u302F\u3099\u309A\uA66F-\uA672\uA674-\uA67D\uA69E\uA69F\uA6F0\uA6F1\uA802\uA806\uA80B\uA823-\uA827\uA880\uA881\uA8B4-\uA8C5\uA8E0-\uA8F1\uA8FF\uA926-\uA92D\uA947-\uA953\uA980-\uA983\uA9B3-\uA9C0\uA9E5\uAA29-\uAA36\uAA43\uAA4C\uAA4D\uAA7B-\uAA7D\uAAB0\uAAB2-\uAAB4\uAAB7\uAAB8\uAABE\uAABF\uAAC1\uAAEB-\uAAEF\uAAF5\uAAF6\uABE3-\uABEA\uABEC\uABED\uFB1E\uFE00-\uFE0F\uFE20-\uFE2F]/g,"").replace(Pt,e=>Se[e]):n=>n;class ce{constructor(e,{location:t=g.location,threshold:i=g.threshold,distance:o=g.distance,includeMatches:r=g.includeMatches,findAllMatches:s=g.findAllMatches,minMatchCharLength:a=g.minMatchCharLength,isCaseSensitive:c=g.isCaseSensitive,ignoreDiacritics:d=g.ignoreDiacritics,ignoreLocation:l=g.ignoreLocation}={}){if(this.options={location:t,threshold:i,distance:o,includeMatches:r,findAllMatches:s,minMatchCharLength:a,isCaseSensitive:c,ignoreDiacritics:d,ignoreLocation:l},e=c?e:e.toLowerCase(),e=d?j(e):e,this.pattern=e,this.chunks=[],!this.pattern.length)return;const p=(h,y)=>{this.chunks.push({pattern:h,alphabet:Tt(h),startIndex:y})},m=this.pattern.length;if(m>S){let h=0;const y=m%S,f=m-y;for(;h<f;)p(this.pattern.substr(h,S),h),h+=S;if(y){const b=m-S;p(this.pattern.substr(b),b)}}else p(this.pattern,0)}searchIn(e){const{isCaseSensitive:t,ignoreDiacritics:i,includeMatches:o}=this.options;if(e=t?e:e.toLowerCase(),e=i?j(e):e,this.pattern===e){const f={isMatch:!0,score:0};return o&&(f.indices=[[0,e.length-1]]),f}const{location:r,distance:s,threshold:a,findAllMatches:c,minMatchCharLength:d,ignoreLocation:l}=this.options,p=[];let m=0,h=!1;this.chunks.forEach(({pattern:f,alphabet:b,startIndex:w})=>{const{isMatch:k,score:I,indices:N}=xt(e,f,b,{location:r+w,distance:s,threshold:a,findAllMatches:c,minMatchCharLength:d,includeMatches:o,ignoreLocation:l});k&&(h=!0),m+=I,k&&N&&p.push(...N)});const y={isMatch:h,score:h?m/this.chunks.length:1};return h&&o&&(y.indices=le(p)),y}}class F{constructor(e){this.pattern=e}static isMultiMatch(e){return ve(e,this.multiRegex)}static isSingleMatch(e){return ve(e,this.singleRegex)}search(e){return{isMatch:!1,score:1}}}function ve(n,e){const t=n.match(e);return t?t[1]:null}class It extends F{constructor(e){super(e)}static get type(){return"exact"}static get multiRegex(){return/^="(.*)"$/}static get singleRegex(){return/^=(.*)$/}search(e){const t=e===this.pattern;return{isMatch:t,score:t?0:1,indices:[0,this.pattern.length-1]}}}class Ct extends F{constructor(e){super(e)}static get type(){return"inverse-exact"}static get multiRegex(){return/^!"(.*)"$/}static get singleRegex(){return/^!(.*)$/}search(e){const i=e.indexOf(this.pattern)===-1;return{isMatch:i,score:i?0:1,indices:[0,e.length-1]}}}class Dt extends F{constructor(e){super(e)}static get type(){return"prefix-exact"}static get multiRegex(){return/^\^"(.*)"$/}static get singleRegex(){return/^\^(.*)$/}search(e){const t=e.startsWith(this.pattern);return{isMatch:t,score:t?0:1,indices:[0,this.pattern.length-1]}}}class Rt extends F{constructor(e){super(e)}static get type(){return"inverse-prefix-exact"}static get multiRegex(){return/^!\^"(.*)"$/}static get singleRegex(){return/^!\^(.*)$/}search(e){const t=!e.startsWith(this.pattern);return{isMatch:t,score:t?0:1,indices:[0,e.length-1]}}}class At extends F{constructor(e){super(e)}static get type(){return"suffix-exact"}static get multiRegex(){return/^"(.*)"\$$/}static get singleRegex(){return/^(.*)\$$/}search(e){const t=e.endsWith(this.pattern);return{isMatch:t,score:t?0:1,indices:[e.length-this.pattern.length,e.length-1]}}}class Mt extends F{constructor(e){super(e)}static get type(){return"inverse-suffix-exact"}static get multiRegex(){return/^!"(.*)"\$$/}static get singleRegex(){return/^!(.*)\$$/}search(e){const t=!e.endsWith(this.pattern);return{isMatch:t,score:t?0:1,indices:[0,e.length-1]}}}class Oe extends F{constructor(e,{location:t=g.location,threshold:i=g.threshold,distance:o=g.distance,includeMatches:r=g.includeMatches,findAllMatches:s=g.findAllMatches,minMatchCharLength:a=g.minMatchCharLength,isCaseSensitive:c=g.isCaseSensitive,ignoreDiacritics:d=g.ignoreDiacritics,ignoreLocation:l=g.ignoreLocation}={}){super(e),this._bitapSearch=new ce(e,{location:t,threshold:i,distance:o,includeMatches:r,findAllMatches:s,minMatchCharLength:a,isCaseSensitive:c,ignoreDiacritics:d,ignoreLocation:l})}static get type(){return"fuzzy"}static get multiRegex(){return/^"(.*)"$/}static get singleRegex(){return/^(.*)$/}search(e){return this._bitapSearch.searchIn(e)}}class Le extends F{constructor(e){super(e)}static get type(){return"include"}static get multiRegex(){return/^'"(.*)"$/}static get singleRegex(){return/^'(.*)$/}search(e){let t=0,i;const o=[],r=this.pattern.length;for(;(i=e.indexOf(this.pattern,t))>-1;)t=i+r,o.push([i,t-1]);const s=!!o.length;return{isMatch:s,score:s?0:1,indices:o}}}const J=[It,Le,Dt,Rt,Mt,At,Ct,Oe],ke=J.length,_t="\0",Ft="|";function Et(n){const e=[],t=n.length;let i=0;for(;i<t;){for(;i<t&&n[i]===" ";)i++;if(i>=t)break;let o=i;for(;o<t&&n[o]!==" "&&n[o]!=='"';)o++;if(o<t&&n[o]==='"'){for(o++;o<t;){if(n[o]==='"'){const r=o+1;if(r>=t||n[r]===" "){o++;break}if(n[r]==="$"&&(r+1>=t||n[r+1]===" ")){o+=2;break}}o++}e.push(n.substring(i,o)),i=o}else{for(;o<t&&n[o]!==" ";)o++;e.push(n.substring(i,o)),i=o}}return e}function Nt(n,e={}){return n.replace(/\\\|/g,_t).split(Ft).map(i=>{const o=i.replace(/\u0000/g,"|"),r=Et(o.trim()).filter(a=>a&&!!a.trim()),s=[];for(let a=0,c=r.length;a<c;a+=1){const d=r[a];let l=!1,p=-1;for(;!l&&++p<ke;){const m=J[p],h=m.isMultiMatch(d);h&&(s.push(new m(h,e)),l=!0)}if(!l)for(p=-1;++p<ke;){const m=J[p],h=m.isSingleMatch(d);if(h){s.push(new m(h,e));break}}}return s})}const St=new Set([Oe.type,Le.type]);class Ot{constructor(e,{isCaseSensitive:t=g.isCaseSensitive,ignoreDiacritics:i=g.ignoreDiacritics,includeMatches:o=g.includeMatches,minMatchCharLength:r=g.minMatchCharLength,ignoreLocation:s=g.ignoreLocation,findAllMatches:a=g.findAllMatches,location:c=g.location,threshold:d=g.threshold,distance:l=g.distance}={}){this.query=null,this.options={isCaseSensitive:t,ignoreDiacritics:i,includeMatches:o,minMatchCharLength:r,findAllMatches:a,ignoreLocation:s,location:c,threshold:d,distance:l},e=t?e:e.toLowerCase(),e=i?j(e):e,this.pattern=e,this.query=Nt(this.pattern,this.options)}static condition(e,t){return t.useExtendedSearch}searchIn(e){const t=this.query;if(!t)return{isMatch:!1,score:1};const{includeMatches:i,isCaseSensitive:o,ignoreDiacritics:r}=this.options;e=o?e:e.toLowerCase(),e=r?j(e):e;let s=0;const a=[];let c=0,d=!1;for(let l=0,p=t.length;l<p;l+=1){const m=t[l];a.length=0,s=0,d=!1;for(let h=0,y=m.length;h<y;h+=1){const f=m[h],{isMatch:b,indices:w,score:k}=f.search(e);if(b){s+=1,c+=k;const I=f.constructor.type;I.startsWith("inverse")&&(d=!0),i&&(St.has(I)?a.push(...w):a.push(w))}else{c=0,s=0,a.length=0,d=!1;break}}if(s){const h={isMatch:!0,score:c/s};return d&&(h.hasInverse=!0),i&&(h.indices=le(a)),h}}return{isMatch:!1,score:1}}}const Z=[];function de(...n){Z.push(...n)}function G(n,e){for(let t=0,i=Z.length;t<i;t+=1){const o=Z[t];if(o.condition(n,e))return new o(n,e)}return new ce(n,e)}const W={AND:"$and",OR:"$or"},ee={PATH:"$path",PATTERN:"$val"},ne=n=>!!(n[W.AND]||n[W.OR]),Lt=n=>!!n[ee.PATH],Bt=n=>!_(n)&&_e(n)&&!ne(n),we=n=>({[W.AND]:Object.keys(n).map(e=>({[e]:n[e]}))});function Be(n,e,{auto:t=!0}={}){const i=o=>{if(x(o)){const c={keyId:null,pattern:o};return t&&(c.searcher=G(o,e)),c}const r=Object.keys(o),s=Lt(o);if(!s&&r.length>1&&!ne(o))return i(we(o));if(Bt(o)){const c=s?o[ee.PATH]:r[0],d=s?o[ee.PATTERN]:o[c];if(!x(d))throw new Error(lt(c));const l={keyId:X(c),pattern:d};return t&&(l.searcher=G(d,e)),l}const a={children:[],operator:r[0]};return r.forEach(c=>{const d=o[c];_(d)&&d.forEach(l=>{a.children.push(i(l))})}),a};return ne(n)||(n=we(n)),i(n)}function te(n,{ignoreFieldNorm:e=g.ignoreFieldNorm}){let t=1;return n.forEach(({key:i,norm:o,score:r})=>{const s=i?i.weight:null;t*=Math.pow(r===0&&s?Number.EPSILON:r,(s||1)*(e?1:o))}),t}function jt(n,{ignoreFieldNorm:e=g.ignoreFieldNorm}){n.forEach(t=>{t.score=te(t.matches,{ignoreFieldNorm:e})})}class Vt{constructor(e){this.limit=e,this.heap=[]}get size(){return this.heap.length}shouldInsert(e){return this.size<this.limit||e<this.heap[0].score}insert(e){this.size<this.limit?(this.heap.push(e),this._bubbleUp(this.size-1)):e.score<this.heap[0].score&&(this.heap[0]=e,this._sinkDown(0))}extractSorted(e){return this.heap.sort(e)}_bubbleUp(e){const t=this.heap;for(;e>0;){const i=e-1>>1;if(t[e].score<=t[i].score)break;const o=t[e];t[e]=t[i],t[i]=o,e=i}}_sinkDown(e){const t=this.heap,i=t.length;let o=e;do{e=o;const r=2*e+1,s=2*e+2;if(r<i&&t[r].score>t[o].score&&(o=r),s<i&&t[s].score>t[o].score&&(o=s),o!==e){const a=t[e];t[e]=t[o],t[o]=a}}while(o!==e)}}function Ut(n,e){const t=n.matches;e.matches=[],P(t)&&t.forEach(i=>{if(!P(i.indices)||!i.indices.length)return;const{indices:o,value:r}=i,s={indices:o,value:r};i.key&&(s.key=i.key.src),i.idx>-1&&(s.refIndex=i.idx),e.matches.push(s)})}function qt(n,e){e.score=n.score}function zt(n,e,{includeMatches:t=g.includeMatches,includeScore:i=g.includeScore}={}){const o=[];return t&&o.push(Ut),i&&o.push(qt),n.map(r=>{const{idx:s}=r,a={item:e[s],refIndex:s};return o.length&&o.forEach(c=>{c(r,a)}),a})}const Gt=/\b\w+\b/g;function oe({isCaseSensitive:n=!1,ignoreDiacritics:e=!1}={}){return{tokenize(t){return n||(t=t.toLowerCase()),e&&(t=j(t)),t.match(Gt)||[]}}}function Wt(n,e,t){const i=new Map,o=new Map;let r=0;function s(a,c,d,l){const p=t.tokenize(a);if(!p.length)return;r++;const m=new Map;for(const h of p)m.set(h,(m.get(h)||0)+1);for(const[h,y]of m){const f={docIdx:c,keyIdx:d,subIdx:l,tf:y};let b=i.get(h);b||(b=[],i.set(h,b)),b.push(f),o.set(h,(o.get(h)||0)+1)}}for(const a of n){const{i:c,v:d,$:l}=a;if(d!==void 0){s(d,c,-1,-1);continue}if(l)for(let p=0;p<e;p++){const m=l[p];if(m)if(Array.isArray(m))for(const h of m)s(h.v,c,p,h.i??-1);else s(m.v,c,p,-1)}}return{terms:i,fieldCount:r,df:o}}function Ht(n,e,t,i){const{i:o,v:r,$:s}=e;function a(c,d,l){const p=i.tokenize(c);if(!p.length)return;n.fieldCount++;const m=new Map;for(const h of p)m.set(h,(m.get(h)||0)+1);for(const[h,y]of m){const f={docIdx:o,keyIdx:d,subIdx:l,tf:y};let b=n.terms.get(h);b||(b=[],n.terms.set(h,b)),b.push(f),n.df.set(h,(n.df.get(h)||0)+1)}}if(r!==void 0){a(r,-1,-1);return}if(s)for(let c=0;c<t;c++){const d=s[c];if(d)if(Array.isArray(d))for(const l of d)a(l.v,c,l.i??-1);else a(d.v,c,-1)}}function xe(n,e){for(const[t,i]of n.terms){const o=i.filter(s=>s.docIdx!==e),r=i.length-o.length;r>0&&(n.fieldCount-=r,n.df.set(t,(n.df.get(t)||0)-r),o.length===0?(n.terms.delete(t),n.df.delete(t)):n.terms.set(t,o))}}class E{constructor(e,t,i){this.options={...g,...t},this.options.useExtendedSearch,this.options.useTokenSearch,this._keyStore=new ht(this.options.keys),this._docs=e,this._myIndex=null,this._invertedIndex=null,this.setCollection(e,i),this._lastQuery=null,this._lastSearcher=null}_getSearcher(e){if(this._lastQuery===e)return this._lastSearcher;const t=this._invertedIndex?{...this.options,_invertedIndex:this._invertedIndex}:this.options,i=G(e,t);return this._lastQuery=e,this._lastSearcher=i,i}setCollection(e,t){if(this._docs=e,t&&!(t instanceof ae))throw new Error(at);if(this._myIndex=t||Ne(this.options.keys,this._docs,{getFn:this.options.getFn,fieldNormWeight:this.options.fieldNormWeight}),this.options.useTokenSearch){const i=oe({isCaseSensitive:this.options.isCaseSensitive,ignoreDiacritics:this.options.ignoreDiacritics});this._invertedIndex=Wt(this._myIndex.records,this._myIndex.keys.length,i)}}add(e){if(P(e)&&(this._docs.push(e),this._myIndex.add(e),this._invertedIndex)){const t=this._myIndex.records[this._myIndex.records.length-1],i=oe({isCaseSensitive:this.options.isCaseSensitive,ignoreDiacritics:this.options.ignoreDiacritics});Ht(this._invertedIndex,t,this._myIndex.keys.length,i)}}remove(e=()=>!1){const t=[],i=[];for(let o=0,r=this._docs.length;o<r;o+=1)e(this._docs[o],o)&&(t.push(this._docs[o]),i.push(o));if(i.length){if(this._invertedIndex)for(const o of i)xe(this._invertedIndex,o);for(let o=i.length-1;o>=0;o-=1)this._docs.splice(i[o],1);this._myIndex.removeAll(i)}return t}removeAt(e){this._invertedIndex&&xe(this._invertedIndex,e);const t=this._docs.splice(e,1)[0];return this._myIndex.removeAt(e),t}getIndex(){return this._myIndex}search(e,t){const{limit:i=-1}=t||{},{includeMatches:o,includeScore:r,shouldSort:s,sortFn:a,ignoreFieldNorm:c}=this.options;if(x(e)&&!e.trim()){let p=this._docs.map((m,h)=>({item:m,refIndex:h}));return z(i)&&i>-1&&(p=p.slice(0,i)),p}const d=z(i)&&i>0&&x(e);let l;if(d){const p=new Vt(i);x(this._docs[0])?this._searchStringList(e,{heap:p,ignoreFieldNorm:c}):this._searchObjectList(e,{heap:p,ignoreFieldNorm:c}),l=p.extractSorted(a)}else l=x(e)?x(this._docs[0])?this._searchStringList(e):this._searchObjectList(e):this._searchLogical(e),jt(l,{ignoreFieldNorm:c}),s&&l.sort(a),z(i)&&i>-1&&(l=l.slice(0,i));return zt(l,this._docs,{includeMatches:o,includeScore:r})}_searchStringList(e,{heap:t,ignoreFieldNorm:i}={}){const o=this._getSearcher(e),{records:r}=this._myIndex,s=t?null:[];return r.forEach(({v:a,i:c,n:d})=>{if(!P(a))return;const{isMatch:l,score:p,indices:m}=o.searchIn(a);if(l){const h={item:a,idx:c,matches:[{score:p,value:a,norm:d,indices:m}]};t?(h.score=te(h.matches,{ignoreFieldNorm:i}),t.shouldInsert(h.score)&&t.insert(h)):s.push(h)}}),s}_searchLogical(e){const t=Be(e,this.options),i=(a,c,d)=>{if(!("children"in a)){const{keyId:h,searcher:y}=a;let f;return h===null?(f=[],this._myIndex.keys.forEach((b,w)=>{f.push(...this._findMatches({key:b,value:c[w],searcher:y}))})):f=this._findMatches({key:this._keyStore.get(h),value:this._myIndex.getValueForItemAtKeyId(c,h),searcher:y}),f&&f.length?[{idx:d,item:c,matches:f}]:[]}const{children:l,operator:p}=a,m=[];for(let h=0,y=l.length;h<y;h+=1){const f=l[h],b=i(f,c,d);if(b.length)m.push(...b);else if(p===W.AND)return[]}return m},o=this._myIndex.records,r=new Map,s=[];return o.forEach(({$:a,i:c})=>{if(P(a)){const d=i(t,a,c);d.length&&(r.has(c)||(r.set(c,{idx:c,item:a,matches:[]}),s.push(r.get(c))),d.forEach(({matches:l})=>{r.get(c).matches.push(...l)}))}}),s}_searchObjectList(e,{heap:t,ignoreFieldNorm:i}={}){const o=this._getSearcher(e),{keys:r,records:s}=this._myIndex,a=t?null:[];return s.forEach(({$:c,i:d})=>{if(!P(c))return;const l=[];let p=!1,m=!1;if(r.forEach((h,y)=>{const f=this._findMatches({key:h,value:c[y],searcher:o});f.length?(l.push(...f),f[0].hasInverse&&(m=!0)):p=!0}),!(m&&p)&&l.length){const h={idx:d,item:c,matches:l};t?(h.score=te(h.matches,{ignoreFieldNorm:i}),t.shouldInsert(h.score)&&t.insert(h)):a.push(h)}}),a}_findMatches({key:e,value:t,searcher:i}){if(!P(t))return[];const o=[];if(_(t))t.forEach(({v:r,i:s,n:a})=>{if(!P(r))return;const{isMatch:c,score:d,indices:l,hasInverse:p}=i.searchIn(r);c&&o.push({score:d,key:e,value:r,idx:s,norm:a,indices:l,hasInverse:p})});else{const{v:r,n:s}=t,{isMatch:a,score:c,indices:d,hasInverse:l}=i.searchIn(r);a&&o.push({score:c,key:e,value:r,norm:s,indices:d,hasInverse:l})}return o}}class Kt{static condition(e,t){return t.useTokenSearch}constructor(e,t){this.options=t,this.analyzer=oe({isCaseSensitive:t.isCaseSensitive,ignoreDiacritics:t.ignoreDiacritics});const i=this.analyzer.tokenize(e),o=t._invertedIndex,{df:r,fieldCount:s}=o;this.termSearchers=[],this.idfWeights=[];for(const a of i){this.termSearchers.push(new ce(a,{location:t.location,threshold:t.threshold,distance:t.distance,includeMatches:t.includeMatches,findAllMatches:t.findAllMatches,minMatchCharLength:t.minMatchCharLength,isCaseSensitive:t.isCaseSensitive,ignoreDiacritics:t.ignoreDiacritics,ignoreLocation:!0}));const c=r.get(a)||0,d=Math.log(1+(s-c+.5)/(c+.5));this.idfWeights.push(d)}}searchIn(e){if(!this.termSearchers.length)return{isMatch:!1,score:1};const t=[];let i=0,o=0,r=0;for(let c=0;c<this.termSearchers.length;c++){const d=this.termSearchers[c].searchIn(e),l=this.idfWeights[c];o+=l,d.isMatch&&(r++,i+=l*(1-d.score),d.indices&&t.push(...d.indices))}if(r===0)return{isMatch:!1,score:1};const s=o>0?1-i/o:0,a={isMatch:!0,score:Math.max(.001,s)};return this.options.includeMatches&&t.length&&(a.indices=le(t)),a}}E.version="7.3.0";E.createIndex=Ne;E.parseIndex=kt;E.config=g;E.match=function(n,e,t){return G(n,{...g,...t}).searchIn(e)};E.parseQuery=Be;de(Ot);de(Kt);E.use=function(...n){n.forEach(e=>de(e))};function Te(n,e,t){const i=Math.max(0,e),o=Math.min(n.length,t),r=n.slice(i,o).trim();return`${i>0?"…":""}${r}${o<n.length?"…":""}`}function Pe(n,e){const t=e?.find(r=>r.key==="content"&&r.indices.length>0);if(!t)return Te(n,0,140);const[i,o]=t.indices[0];return Te(n,i-60,o+90)}function $t(n,e){const t=new Map(se.map(o=>[o.to,{codeSnippetCount:o.codeSnippetCount,headingCount:o.headings.length}])),i=new Map;for(const o of n){const r=t.get(o.to)??{codeSnippetCount:0,headingCount:0},s=i.get(o.to)??{codeSnippetCount:r.codeSnippetCount,headingCount:r.headingCount,items:[],pagePreview:void 0,pageScore:Number.POSITIVE_INFINITY,score:o.score,section:o.section,title:o.title,to:o.to};s.score=Math.min(s.score,o.score),o.heading?s.items.some(a=>a.id===o.id)||s.items.push(o):(!s.pagePreview||o.score<s.pageScore)&&(s.pagePreview=o.preview,s.pageScore=o.score),i.set(o.to,s)}return[...i.values()].sort((o,r)=>o.score-r.score).slice(0,e?6:8).map(o=>({...o,items:o.items.sort((r,s)=>r.score-s.score).slice(0,e?4:2)}))}function Ie(){const[n,e]=v.useState(!1),[t,i]=v.useState(""),o=v.useRef(null),r=v.useMemo(()=>new E(ot,{keys:[{name:"title",weight:.35},{name:"heading",weight:.3},{name:"section",weight:.1},{name:"content",weight:.25}],threshold:.34,ignoreLocation:!0,minMatchCharLength:2,includeMatches:!0,includeScore:!0}),[]),s=t.trim(),a=v.useMemo(()=>s?r.search(s).slice(0,24).map(d=>({...d.item,preview:Pe(d.item.content,d.matches),score:d.score??0})):se.slice(0,8).map(d=>({content:d.content,id:`${d.to}#page`,preview:Pe(d.content),score:0,section:d.section,title:d.title,to:d.to})),[r,s]),c=v.useMemo(()=>$t(a,!!s),[s,a]);return v.useEffect(()=>{const d=l=>{(l.metaKey||l.ctrlKey)&&l.key==="k"&&(l.preventDefault(),e(!0)),l.key==="Escape"&&e(!1)};return window.addEventListener("keydown",d),()=>window.removeEventListener("keydown",d)},[]),v.useEffect(()=>{n&&setTimeout(()=>o.current?.focus(),50)},[n]),u.jsxs(u.Fragment,{children:[u.jsxs("button",{onClick:()=>e(!0),className:"inline-flex h-10 w-full max-w-sm items-center gap-3 rounded-xl border border-border/80 bg-background/90 px-3.5 text-sm text-muted-foreground shadow-sm transition hover:border-border hover:bg-background hover:text-foreground",children:[u.jsx(fe,{className:"h-4 w-4 shrink-0"}),u.jsx("span",{className:"flex-1 text-left",children:"Search documentation..."}),u.jsx("kbd",{className:"hidden rounded-md border border-border bg-muted px-1.5 py-0.5 text-[10px] text-muted-foreground sm:inline",children:"⌘ K"})]}),n&&u.jsx("div",{className:"fixed inset-0 z-50 flex items-start justify-center bg-slate-950/22 px-4 pt-18 backdrop-blur-[3px] sm:pt-24",onClick:()=>e(!1),children:u.jsxs("div",{onClick:d=>d.stopPropagation(),className:"w-full max-w-3xl overflow-hidden rounded-[1.35rem] border border-border/80 bg-background/95 shadow-[0_30px_90px_-38px_rgba(15,23,42,0.55)]",children:[u.jsxs("div",{className:"flex items-center gap-3 border-b border-border/70 px-4 py-3.5 sm:px-5",children:[u.jsx(fe,{className:"h-4 w-4 shrink-0 text-muted-foreground"}),u.jsx("input",{ref:o,value:t,onChange:d=>i(d.target.value),placeholder:"Search the docs...",className:"flex-1 bg-transparent text-[15px] text-foreground outline-none placeholder:text-muted-foreground"}),u.jsx("button",{onClick:()=>e(!1),className:"rounded-md p-1 text-muted-foreground transition hover:bg-accent/70 hover:text-foreground","aria-label":"Close search",children:u.jsx(De,{className:"h-4 w-4"})})]}),u.jsx("div",{className:"border-b border-border/60 px-4 py-2 text-[11px] font-medium tracking-[0.18em] text-muted-foreground uppercase sm:px-5",children:s?"Search Results":"Browse Docs"}),u.jsx("div",{className:"max-h-[34rem] overflow-y-auto px-2 py-2 sm:px-3",children:c.length===0?u.jsxs("div",{className:"px-4 py-10 text-center text-sm text-muted-foreground",children:['No results for "',s,'"']}):u.jsx("div",{className:"divide-y divide-border/60",children:c.map(d=>u.jsxs("section",{className:"px-2 py-2.5",children:[u.jsx(M,{to:d.to,onClick:()=>e(!1),className:"group block rounded-2xl px-3 py-3 transition hover:bg-accent/45",children:u.jsxs("div",{className:"flex items-start gap-3",children:[u.jsx("div",{className:"mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-muted text-muted-foreground",children:u.jsx(gn,{className:"h-4 w-4"})}),u.jsxs("div",{className:"min-w-0 flex-1",children:[u.jsx("div",{className:"truncate text-[11px] font-medium tracking-[0.18em] text-muted-foreground uppercase",children:d.section}),u.jsx("div",{className:"mt-1 truncate text-[15px] font-semibold text-foreground",children:d.title}),u.jsxs("div",{className:"mt-2 flex flex-wrap gap-2",children:[d.headingCount>0&&u.jsx(Ce,{label:"Main Topics"}),d.codeSnippetCount>0&&u.jsx(Ce,{label:"Code Snippets"})]})]}),u.jsx(ln,{className:"mt-1 h-4 w-4 shrink-0 text-muted-foreground transition group-hover:text-foreground"})]})}),d.items.length>0&&u.jsxs("div",{className:"mt-1 space-y-1 pl-12",children:[u.jsx("div",{className:"px-3 pt-1 text-[11px] font-medium tracking-[0.18em] text-muted-foreground uppercase",children:"Main Topics"}),d.items.map(l=>u.jsxs(M,{to:l.to,hash:l.anchor?()=>l.anchor:void 0,onClick:()=>e(!1),className:"group flex gap-3 rounded-xl px-3 py-2.5 transition hover:bg-accent/35",children:[u.jsx("div",{className:"flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-muted/70 text-muted-foreground transition group-hover:bg-background",children:l.headingLevel===3?u.jsx(pn,{className:"h-3.5 w-3.5"}):u.jsx(yn,{className:"h-3.5 w-3.5"})}),u.jsxs("div",{className:"min-w-0 flex-1",children:[u.jsx("div",{className:"truncate text-sm font-medium text-foreground",children:l.heading}),u.jsx("p",{className:"mt-1 text-[13px] leading-5 text-muted-foreground",style:{display:"-webkit-box",WebkitBoxOrient:"vertical",WebkitLineClamp:2,overflow:"hidden"},children:l.preview})]})]},l.id))]})]},d.to))})})]})})]})}function Ce({label:n}){return u.jsx("span",{className:"rounded-full border border-border/70 bg-muted/60 px-2.5 py-1 text-[11px] font-medium tracking-[0.08em] text-muted-foreground uppercase",children:n})}var H="Collapsible",[Yt]=rn(H),[Qt,ue]=Yt(H),je=v.forwardRef((n,e)=>{const{__scopeCollapsible:t,open:i,defaultOpen:o,disabled:r,onOpenChange:s,...a}=n,[c,d]=Ze({prop:i,defaultProp:o??!1,onChange:s,caller:H});return u.jsx(Qt,{scope:t,disabled:r,contentId:en(),open:c,onOpenToggle:v.useCallback(()=>d(l=>!l),[d]),children:u.jsx(re.div,{"data-state":pe(c),"data-disabled":r?"":void 0,...a,ref:e})})});je.displayName=H;var Ve="CollapsibleTrigger",Ue=v.forwardRef((n,e)=>{const{__scopeCollapsible:t,...i}=n,o=ue(Ve,t);return u.jsx(re.button,{type:"button","aria-controls":o.contentId,"aria-expanded":o.open||!1,"data-state":pe(o.open),"data-disabled":o.disabled?"":void 0,disabled:o.disabled,...i,ref:e,onClick:nn(n.onClick,o.onOpenToggle)})});Ue.displayName=Ve;var he="CollapsibleContent",qe=v.forwardRef((n,e)=>{const{forceMount:t,...i}=n,o=ue(he,n.__scopeCollapsible);return u.jsx(tn,{present:t||o.open,children:({present:r})=>u.jsx(Xt,{...i,ref:e,present:r})})});qe.displayName=he;var Xt=v.forwardRef((n,e)=>{const{__scopeCollapsible:t,present:i,children:o,...r}=n,s=ue(he,t),[a,c]=v.useState(i),d=v.useRef(null),l=Qe(e,d),p=v.useRef(0),m=p.current,h=v.useRef(0),y=h.current,f=s.open||a,b=v.useRef(f),w=v.useRef(void 0);return v.useEffect(()=>{const k=requestAnimationFrame(()=>b.current=!1);return()=>cancelAnimationFrame(k)},[]),on(()=>{const k=d.current;if(k){w.current=w.current||{transitionDuration:k.style.transitionDuration,animationName:k.style.animationName},k.style.transitionDuration="0s",k.style.animationName="none";const I=k.getBoundingClientRect();p.current=I.height,h.current=I.width,b.current||(k.style.transitionDuration=w.current.transitionDuration,k.style.animationName=w.current.animationName),c(i)}},[s.open,i]),u.jsx(re.div,{"data-state":pe(s.open),"data-disabled":s.disabled?"":void 0,id:s.contentId,hidden:!f,...r,ref:l,style:{"--radix-collapsible-content-height":m?`${m}px`:void 0,"--radix-collapsible-content-width":y?`${y}px`:void 0,...n.style},children:f&&o})});function pe(n){return n?"open":"closed"}var Jt=je;const Zt=Jt,eo=Ue,no=qe;function to(){const n=sn(),[e,t]=v.useState(!1),i=L.findIndex(a=>a.to===n.pathname),o=i>0?L[i-1]:null,r=i>=0&&i<L.length-1?L[i+1]:null,s=L[i];return v.useEffect(()=>{const a=document.querySelectorAll(".prose-docs h2, .prose-docs h3"),c=new Map;for(const d of a){const l=d.textContent?.trim();if(!l)continue;const p=Me(l)||"section",m=c.get(p)??0;c.set(p,m+1),d.id=m===0?p:`${p}-${m+1}`}},[n.pathname]),u.jsxs("div",{className:"min-h-screen bg-background",children:[u.jsx("header",{className:"sticky top-0 z-40 border-b border-border bg-background/80 backdrop-blur",children:u.jsxs("div",{className:"mx-auto flex h-14 max-w-[1400px] items-center gap-4 px-4 lg:px-6",children:[u.jsx("button",{className:"lg:hidden",onClick:()=>t(a=>!a),"aria-label":"Toggle menu",children:e?u.jsx(De,{className:"h-5 w-5"}):u.jsx(vn,{className:"h-5 w-5"})}),u.jsxs(M,{to:"/",className:"flex items-center gap-2",children:[u.jsx("img",{src:Ye,alt:"PID Pilot",className:"h-8 w-8"}),u.jsx("span",{className:"font-display text-lg font-semibold tracking-tight",children:"PID Pilot"}),u.jsx("span",{className:"hidden rounded-md border border-border bg-muted px-1.5 py-0.5 font-mono text-[10px] text-muted-foreground sm:inline",children:"docs"})]}),u.jsx("div",{className:"flex-1"}),u.jsxs("nav",{className:"hidden items-center gap-4 sm:flex",children:[u.jsx(M,{to:"/guide",className:ie("text-sm font-medium transition",n.pathname.startsWith("/guide")?"text-foreground":"text-muted-foreground hover:text-foreground"),children:"Docs"}),u.jsx(M,{to:"/tuner",className:"text-sm font-medium text-muted-foreground transition hover:text-foreground",children:"Tuner"})]}),u.jsx("div",{className:"hidden md:block",children:u.jsx(Ie,{})}),u.jsx(Xe,{className:"h-9 w-9"})]})}),u.jsxs("div",{className:"mx-auto flex max-w-[1400px] gap-4 px-4 sm:gap-6 lg:px-6 xl:gap-8",children:[u.jsxs("aside",{className:`${e?"block":"hidden"} fixed inset-x-0 top-14 z-30 max-h-[calc(100vh-3.5rem)] overflow-y-auto border-b border-border bg-sidebar px-4 py-3 shadow-sm lg:sticky lg:top-14 lg:block lg:max-h-[calc(100vh-3.5rem)] lg:w-64 lg:flex-shrink-0 lg:border-0 lg:bg-transparent lg:px-0 lg:py-6 lg:shadow-none`,children:[u.jsx("div",{className:"mb-4 lg:hidden",children:u.jsx(Ie,{})}),u.jsx("nav",{className:"space-y-4 pb-8 lg:space-y-5 lg:pb-12",children:Ae.map(a=>u.jsxs("div",{children:[u.jsx("h4",{className:"mb-2 px-2 font-display text-xs font-semibold uppercase tracking-wider text-muted-foreground",children:a.title}),u.jsx("ul",{className:"space-y-0.5",children:a.links.map(c=>Re(c)?u.jsx(oo,{title:c.title,links:c.links,pathname:n.pathname,onNavigate:()=>t(!1)},`${a.title}-${c.title}`):u.jsx(ze,{link:c,active:n.pathname===c.to,onNavigate:()=>t(!1)},c.to))})]},a.title))})]}),u.jsxs("main",{className:"min-w-0 flex-1 py-6 sm:py-8 lg:py-10 xl:py-12",children:[s&&u.jsxs("div",{className:"mb-4 flex flex-wrap items-center gap-1.5 text-xs text-muted-foreground",children:[u.jsx("span",{children:"Docs"}),u.jsx(ge,{className:"h-3 w-3"}),u.jsx("span",{children:s.section}),u.jsx(ge,{className:"h-3 w-3"}),u.jsx("span",{className:"text-foreground",children:s.title})]}),u.jsx("article",{className:"prose-docs",children:u.jsx($e,{})}),u.jsxs("div",{className:"mt-16 grid gap-3 border-t border-border pt-8 sm:grid-cols-2",children:[o?u.jsxs(M,{to:o.to,className:"group rounded-lg border border-border p-4 transition hover:border-brand/50 hover:bg-accent/30",children:[u.jsx("div",{className:"text-xs text-muted-foreground",children:"← Previous"}),u.jsx("div",{className:"mt-1 font-medium text-foreground group-hover:text-brand",children:o.title})]}):u.jsx("div",{}),r&&u.jsxs(M,{to:r.to,className:"group rounded-lg border border-border p-4 text-right transition hover:border-brand/50 hover:bg-accent/30 sm:col-start-2",children:[u.jsx("div",{className:"text-xs text-muted-foreground",children:"Next →"}),u.jsx("div",{className:"mt-1 font-medium text-foreground group-hover:text-brand",children:r.title})]})]})]})]}),u.jsx(Je,{})]})}function ze({link:n,active:e,onNavigate:t,compact:i=!1}){return u.jsx("li",{children:u.jsx(M,{to:n.to,onClick:t,className:ie("block rounded-md border-l-2 text-sm transition",i?"px-3 py-1.5":"px-3 py-2",e?"border-brand bg-brand-muted font-medium text-brand":"border-transparent text-muted-foreground hover:border-border hover:bg-accent/50 hover:text-foreground"),children:n.title})})}function oo({title:n,links:e,pathname:t,onNavigate:i}){const o=e.some(a=>a.to===t),[r,s]=v.useState(o);return v.useEffect(()=>{o&&s(!0)},[o]),u.jsx("li",{children:u.jsxs(Zt,{open:r,onOpenChange:s,children:[u.jsxs(eo,{className:ie("group flex w-full items-center justify-between rounded-md border border-transparent px-3 py-2 text-left text-sm transition",o?"bg-brand-muted font-medium text-brand":"text-muted-foreground hover:border-border hover:bg-accent/50 hover:text-foreground"),children:[u.jsx("span",{children:n}),u.jsx(dn,{className:"h-4 w-4 transition duration-200 group-data-[state=open]:rotate-180"})]}),u.jsx(no,{className:"mt-1 space-y-0.5 pl-3",children:u.jsx("ul",{className:"space-y-0.5 border-l border-border/80",children:e.map(a=>u.jsx(ze,{link:a,active:t===a.to,onNavigate:i,compact:!0},a.to))})})]})})}const ho=to;export{ho as component};
