...
Diagnostics/phase              RUNNING`}),e.jsx("h2",{children:"5. Put them in your real subsystem"}),e.jsxs("ol",{children:[e.jsx("li",{children:"Drop the selected gains into the mechanism class you run in teleop / autonomous."}),e.jsx("li",{children:"Test under the real task, not just under the tuner OpMode."}),e.jsx("li",{children:"Re-run the tune if gearing, inertia, weight, or feedback changes."})]}),e.jsx("h2",{children:"Prefer to tune by hand?"}),e.jsxs("p",{children:["Auto-tune is the default, not a requirement. Supply ",e.jsx("code",{children:".revUpGains(...)"})," and"," ",e.jsx("code",{children:".maintainGains(...)"})," to start from your own values, or call"," ",e.jsx("code",{children:".skipRelayTuning()"})," to disable it entirely and adjust every gain live in Dashboard. The ",e.jsx(t,{to:"/guide/concepts/pidf-terms",children:"Concepts"})," and Advanced sections cover the manual workflow."]}),e.jsxs("blockquote",{children:["Next: grab a full working example from ",e.jsx(t,{to:"/guide/templates",children:"Sample OpModes"}),", or read ",e.jsx(t,{to:"/guide/concepts/scoring",children:"How Auto-Tune Works"})," to understand what just happened."]})]})}export{s as component};
