...
`,Kn=Object.assign({"../routes/guide.concepts.pidf-terms.tsx":xn,"../routes/guide.concepts.scoring.tsx":Tn,"../routes/guide.concepts.tuning-modes.tsx":Pn,"../routes/guide.index.tsx":In,"../routes/guide.installation.tsx":Cn,"../routes/guide.position.auto-tune.tsx":Rn,"../routes/guide.position.config.tsx":An,"../routes/guide.position.disturbance.tsx":Dn,"../routes/guide.position.hold-f.tsx":Mn,"../routes/guide.position.ku-search.tsx":_n,"../routes/guide.position.overview.tsx":Fn,"../routes/guide.position.refinement.tsx":Nn,"../routes/guide.quick-start.tsx":En,"../routes/guide.reference.faq.tsx":Sn,"../routes/guide.reference.practical-notes.tsx":On,"../routes/guide.reference.setup-rules.tsx":Ln,"../routes/guide.reference.telemetry.tsx":Bn,"../routes/guide.templates.tsx":jn,"../routes/guide.troubleshooting.tsx":Vn,"../routes/guide.tsx":qn,"../routes/guide.velocity.config.tsx":zn,"../routes/guide.velocity.disruption.tsx":Wn,"../routes/guide.velocity.f-sweep.tsx":Un,"../routes/guide.velocity.ku-search.tsx":Gn,"../routes/guide.velocity.overview.tsx":Hn,"../routes/guide.velocity.refinement.tsx":$n});function Yn(t){return t==="/guide"?"../routes/guide.index.tsx":`../routes/guide.${t.replace(/^\/guide\//,"").replaceAll("/",".")}.tsx`}function Qn(t){return t.match(/function Page\(\)\s*\{[\s\S]*?return\s*\(([\s\S]*?)\);\s*\}/)?.[1]??t}function Jn(t){return t.replace(/\s+/g," ").trim()}function Y(t){return Jn(t.replace(/<CodeBlock[\s\S]*?code=\{`([\s\S]*?)`\}[\s\S]*?\/>/g," $1 ").replace(/\{\s*" "\s*\}/g," ").replace(/\{\s*' '\s*\}/g," ").replace(/\{"([^"]*?)"\}/g," $1 ").replace(/\{'([^']*?)'\}/g," $1 ").replace(/\{\/\*[\s\S]*?\*\/\}/g," ").replace(/\{[\s\S]*?\}/g," ").replace(/<[^>]+>/g," "))}function Me(t){return t.toLowerCase().replace(/&amp;/g,"and").replace(/[^a-z0-9\s-]/g,"").trim().replace(/\s+/g,"-").replace(/-+/g,"-")}function Zn(t,e){const n=Me(t)||"section",i=e.get(n)??0;return e.set(n,i+1),i===0?n:`${n}-${i+1}`}function Xn(t){const e=[...t.matchAll(/<(h[1-3])>([\s\S]*?)<\/\1>/g)].map(i=>({end:(i.index??0)+i[0].length,index:i.index??0,level:Number(i[1].slice(1)),title:Y(i[2])})),n=new Map;return e.filter(i=>!!i.title).map((i,o,r)=>{const s=r[o+1],a=Y(t.slice(i.end,s?.index??t.length));return{...i,anchor:Zn(i.title,n),content:a}})}function et(t){return[...t.matchAll(/<CodeBlock\b/g)].length}function nt(t){const e=Kn[Yn(t.to)]??"",n=Qn(e),i=Xn(n);return{...t,content:Y(n),codeSnippetCount:et(n),headings:i.filter(o=>o.level===2||o.level===3)}}const se=L.map(nt),tt=se.flatMap(t=>[{content:t.content,id:`${t.to}#page`,section:t.section,title:t.title,to:t.to},...t.headings.map(e=>({anchor:e.anchor,content:e.content,heading:e.title,headingLevel:e.level,id:`${t.to}#${e.anchor}`,section:t.section,title:t.title,to:t.to}))]);function _(t){return Array.isArray?Array.isArray(t):Fe(t)==="[object Array]"}function ot(t){if(typeof t=="string")return t;if(typeof t=="bigint")return t.toString();const e=t+"";return e=="0"&&1/t==-1/0?"-0":e}function Q(t){return t==null?"":ot(t)}function x(t){return typeof t=="string"}function W(t){return typeof t=="number"}function it(t){return t===!0||t===!1||rt(t)&&Fe(t)=="[object Boolean]"}function _e(t){return typeof t=="object"}function rt(t){return _e(t)&&t!==null}function P(t){return t!=null}function z(t){return!t.trim().length}function Fe(t){return t==null?t===void 0?"[object Undefined]":"[object Null]":Object.prototype.toString.call(t)}const st="Incorrect 'index' type",at=t=>`Invalid value for key ${t}`,lt=t=>`Pattern length exceeds max of ${t}.`,ct=t=>`Missing ${t} property in key`,dt=t=>`Property 'weight' in key '${t}' must be a positive integer`,ye=Object.prototype.hasOwnProperty;class ut{constructor(e){this._keys=[],this._keyMap={};let n=0;e.forEach(i=>{const o=Ne(i);this._keys.push(o),this._keyMap[o.id]=o,n+=o.weight}),this._keys.forEach(i=>{i.weight/=n})}get(e){return this._keyMap[e]}keys(){return this._keys}toJSON(){return JSON.stringify(this._keys)}}function Ne(t){let e=null,n=null,i=null,o=1,r=null;if(x(t)||_(t))i=t,e=be(t),n=J(t);else{if(!ye.call(t,"name"))throw new Error(ct("name"));const s=t.name;if(i=s,ye.call(t,"weight")&&(o=t.weight,o<=0))throw new Error(dt(s));e=be(s),n=J(s),r=t.getFn}return{path:e,id:n,weight:o,src:i,getFn:r}}function be(t){return _(t)?t:t.split(".")}function J(t){return _(t)?t.join("."):t}function ht(t,e){const n=[];let i=!1;const o=(r,s,a,c)=>{if(P(r))if(!s[a])n.push(c!==void 0?{v:r,i:c}:r);else{const d=s[a],l=r[d];if(!P(l))return;if(a===s.length-1&&(x(l)||W(l)||it(l)||typeof l=="bigint"))n.push(c!==void 0?{v:Q(l),i:c}:Q(l));else if(_(l)){i=!0;for(let p=0,m=l.length;p<m;p+=1)o(l[p],s,a+1,p)}else s.length&&o(l,s,a+1,c)}};return o(t,x(e)?e.split("."):e,0),i?n:n[0]}const pt={includeMatches:!1,findAllMatches:!1,minMatchCharLength:1},mt={isCaseSensitive:!1,ignoreDiacritics:!1,includeScore:!1,keys:[],shouldSort:!0,sortFn:(t,e)=>t.score===e.score?t.idx<e.idx?-1:1:t.score<e.score?-1:1},gt={location:0,threshold:.6,distance:100},ft={useExtendedSearch:!1,useTokenSearch:!1,getFn:ht,ignoreLocation:!1,ignoreFieldNorm:!1,fieldNormWeight:1},g=Object.freeze({...mt,...pt,...gt,...ft}),yt=/[^ ]+/g;function bt(t=1,e=3){const n=new Map,i=Math.pow(10,e);return{get(o){const r=o.match(yt).length;if(n.has(r))return n.get(r);const s=1/Math.pow(r,.5*t),a=parseFloat(Math.round(s*i)/i);return n.set(r,a),a},clear(){n.clear()}}}class ae{constructor({getFn:e=g.getFn,fieldNormWeight:n=g.fieldNormWeight}={}){this.norm=bt(n,3),this.getFn=e,this.isCreated=!1,this.docs=[],this.keys=[],this._keysMap={},this.setIndexRecords()}setSources(e=[]){this.docs=e}setIndexRecords(e=[]){this.records=e}setKeys(e=[]){this.keys=e,this._keysMap={},e.forEach((n,i)=>{this._keysMap[n.id]=i})}create(){this.isCreated||!this.docs.length||(this.isCreated=!0,x(this.docs[0])?this.docs.forEach((e,n)=>{this._addString(e,n)}):this.docs.forEach((e,n)=>{this._addObject(e,n)}),this.norm.clear())}add(e){const n=this.size();x(e)?this._addString(e,n):this._addObject(e,n)}removeAt(e){this.records.splice(e,1);for(let n=e,i=this.size();n<i;n+=1)this.records[n].i-=1}removeAll(e){for(let n=e.length-1;n>=0;n-=1)this.records.splice(e[n],1);for(let n=0,i=this.records.length;n<i;n+=1)this.records[n].i=n}getValueForItemAtKeyId(e,n){return e[this._keysMap[n]]}size(){return this.records.length}_addString(e,n){if(!P(e)||z(e))return;const i={v:e,i:n,n:this.norm.get(e)};this.records.push(i)}_addObject(e,n){const i={i:n,$:{}};this.keys.forEach((o,r)=>{const s=o.getFn?o.getFn(e):this.getFn(e,o.path);if(P(s)){if(_(s)){const a=[];for(let c=0,d=s.length;c<d;c+=1){const l=s[c];if(P(l)){if(x(l)){if(!z(l)){const p={v:l,i:c,n:this.norm.get(l)};a.push(p)}}else if(P(l.v)){const p=x(l.v)?l.v:Q(l.v);if(!z(p)){const m={v:p,i:l.i,n:this.norm.get(p)};a.push(m)}}}}i.$[r]=a}else if(x(s)&&!z(s)){const a={v:s,n:this.norm.get(s)};i.$[r]=a}}}),this.records.push(i)}toJSON(){return{keys:this.keys.map(({getFn:e,...n})=>n),records:this.records}}}function Ee(t,e,{getFn:n=g.getFn,fieldNormWeight:i=g.fieldNormWeight}={}){const o=new ae({getFn:n,fieldNormWeight:i});return o.setKeys(t.map(Ne)),o.setSources(e),o.create(),o}function vt(t,{getFn:e=g.getFn,fieldNormWeight:n=g.fieldNormWeight}={}){const{keys:i,records:o}=t,r=new ae({getFn:e,fieldNormWeight:n});return r.setKeys(i),r.setIndexRecords(o),r}function wt(t=[],e=g.minMatchCharLength){const n=[];let i=-1,o=-1,r=0;for(let s=t.length;r<s;r+=1){const a=t[r];a&&i===-1?i=r:!a&&i!==-1&&(o=r-1,o-i+1>=e&&n.push([i,o]),i=-1)}return t[r-1]&&r-i>=e&&n.push([i,r-1]),n}const S=32;function kt(t,e,n,{location:i=g.location,distance:o=g.distance,threshold:r=g.threshold,findAllMatches:s=g.findAllMatches,minMatchCharLength:a=g.minMatchCharLength,includeMatches:c=g.includeMatches,ignoreLocation:d=g.ignoreLocation}={}){if(e.length>S)throw new Error(lt(S));const l=e.length,p=t.length,m=Math.max(0,Math.min(i,p));let h=r,y=m;const f=(T,A)=>{const C=T/l;if(d)return C;const B=Math.abs(m-A);return o?C+B/o:B?1:C},b=a>1||c,k=b?Array(p):[];let w;for(;(w=t.indexOf(e,y))>-1;){const T=f(0,w);if(h=Math.min(T,h),y=w+l,b){let A=0;for(;A<l;)k[w+A]=1,A+=1}}y=-1;let I=[],E=1,V=l+p;const Ue=1<<l-1;for(let T=0;T<l;T+=1){let A=0,C=V;for(;A<C;)f(T,m+C)<=h?A=C:V=C,C=Math.floor((V-A)/2+A);V=C;let B=Math.max(1,m-C+1);const K=s?p:Math.min(m+C,p)+l,O=Array(K+2);O[K+1]=(1<<T)-1;for(let R=K;R>=B;R-=1){const q=R-1,me=n[t[q]];if(b&&(k[q]=+!!me),O[R]=(O[R+1]<<1|1)&me,T&&(O[R]|=(I[R+1]|I[R])<<1|1|I[R+1]),O[R]&Ue&&(E=f(T,q),E<=h)){if(h=E,y=q,y<=m)break;B=Math.max(1,2*m-y)}}if(f(T+1,m)>h)break;I=O}const $={isMatch:y>=0,score:Math.max(.001,E)};if(b){const T=wt(k,a);T.length?c&&($.indices=T):$.isMatch=!1}return $}function xt(t){const e={};for(let n=0,i=t.length;n<i;n+=1){const o=t.charAt(n);e[o]=(e[o]||0)|1<<i-n-1}return e}function le(t){if(t.length<=1)return t;t.sort((n,i)=>n[0]-i[0]||n[1]-i[1]);const e=[t[0]];for(let n=1,i=t.length;n<i;n+=1){const o=e[e.length-1],r=t[n];r[0]<=o[1]+1?o[1]=Math.max(o[1],r[1]):e.push(r)}return e}const Se={ł:"l",Ł:"L",đ:"d",Đ:"D",ø:"o",Ø:"O",ħ:"h",Ħ:"H",ŧ:"t",Ŧ:"T",ı:"i",ß:"ss"},Tt=new RegExp("["+Object.keys(Se).join("")+"]","g"),j=String.prototype.normalize?t=>t.normalize("NFD").replace(/[\u0300-\u036F\u0483-\u0489\u0591-\u05BD\u05BF\u05C1\u05C2\u05C4\u05C5\u05C7\u0610-\u061A\u064B-\u065F\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7\u06E8\u06EA-\u06ED\u0711\u0730-\u074A\u07A6-\u07B0\u07EB-\u07F3\u07FD\u0816-\u0819\u081B-\u0823\u0825-\u0827\u0829-\u082D\u0859-\u085B\u08D3-\u08E1\u08E3-\u0903\u093A-\u093C\u093E-\u094F\u0951-\u0957\u0962\u0963\u0981-\u0983\u09BC\u09BE-\u09C4\u09C7\u09C8\u09CB-\u09CD\u09D7\u09E2\u09E3\u09FE\u0A01-\u0A03\u0A3C\u0A3E-\u0A42\u0A47\u0A48\u0A4B-\u0A4D\u0A51\u0A70\u0A71\u0A75\u0A81-\u0A83\u0ABC\u0ABE-\u0AC5\u0AC7-\u0AC9\u0ACB-\u0ACD\u0AE2\u0AE3\u0AFA-\u0AFF\u0B01-\u0B03\u0B3C\u0B3E-\u0B44\u0B47\u0B48\u0B4B-\u0B4D\u0B56\u0B57\u0B62\u0B63\u0B82\u0BBE-\u0BC2\u0BC6-\u0BC8\u0BCA-\u0BCD\u0BD7\u0C00-\u0C04\u0C3E-\u0C44\u0C46-\u0C48\u0C4A-\u0C4D\u0C55\u0C56\u0C62\u0C63\u0C81-\u0C83\u0CBC\u0CBE-\u0CC4\u0CC6-\u0CC8\u0CCA-\u0CCD\u0CD5\u0CD6\u0CE2\u0CE3\u0D00-\u0D03\u0D3B\u0D3C\u0D3E-\u0D44\u0D46-\u0D48\u0D4A-\u0D4D\u0D57\u0D62\u0D63\u0D82\u0D83\u0DCA\u0DCF-\u0DD4\u0DD6\u0DD8-\u0DDF\u0DF2\u0DF3\u0E31\u0E34-\u0E3A\u0E47-\u0E4E\u0EB1\u0EB4-\u0EB9\u0EBB\u0EBC\u0EC8-\u0ECD\u0F18\u0F19\u0F35\u0F37\u0F39\u0F3E\u0F3F\u0F71-\u0F84\u0F86\u0F87\u0F8D-\u0F97\u0F99-\u0FBC\u0FC6\u102B-\u103E\u1056-\u1059\u105E-\u1060\u1062-\u1064\u1067-\u106D\u1071-\u1074\u1082-\u108D\u108F\u109A-\u109D\u135D-\u135F\u1712-\u1714\u1732-\u1734\u1752\u1753\u1772\u1773\u17B4-\u17D3\u17DD\u180B-\u180D\u1885\u1886\u18A9\u1920-\u192B\u1930-\u193B\u1A17-\u1A1B\u1A55-\u1A5E\u1A60-\u1A7C\u1A7F\u1AB0-\u1ABE\u1B00-\u1B04\u1B34-\u1B44\u1B6B-\u1B73\u1B80-\u1B82\u1BA1-\u1BAD\u1BE6-\u1BF3\u1C24-\u1C37\u1CD0-\u1CD2\u1CD4-\u1CE8\u1CED\u1CF2-\u1CF4\u1CF7-\u1CF9\u1DC0-\u1DF9\u1DFB-\u1DFF\u20D0-\u20F0\u2CEF-\u2CF1\u2D7F\u2DE0-\u2DFF\u302A-\u302F\u3099\u309A\uA66F-\uA672\uA674-\uA67D\uA69E\uA69F\uA6F0\uA6F1\uA802\uA806\uA80B\uA823-\uA827\uA880\uA881\uA8B4-\uA8C5\uA8E0-\uA8F1\uA8FF\uA926-\uA92D\uA947-\uA953\uA980-\uA983\uA9B3-\uA9C0\uA9E5\uAA29-\uAA36\uAA43\uAA4C\uAA4D\uAA7B-\uAA7D\uAAB0\uAAB2-\uAAB4\uAAB7\uAAB8\uAABE\uAABF\uAAC1\uAAEB-\uAAEF\uAAF5\uAAF6\uABE3-\uABEA\uABEC\uABED\uFB1E\uFE00-\uFE0F\uFE20-\uFE2F]/g,"").replace(Tt,e=>Se[e]):t=>t;class ce{constructor(e,{location:n=g.location,threshold:i=g.threshold,distance:o=g.distance,includeMatches:r=g.includeMatches,findAllMatches:s=g.findAllMatches,minMatchCharLength:a=g.minMatchCharLength,isCaseSensitive:c=g.isCaseSensitive,ignoreDiacritics:d=g.ignoreDiacritics,ignoreLocation:l=g.ignoreLocation}={}){if(this.options={location:n,threshold:i,distance:o,includeMatches:r,findAllMatches:s,minMatchCharLength:a,isCaseSensitive:c,ignoreDiacritics:d,ignoreLocation:l},e=c?e:e.toLowerCase(),e=d?j(e):e,this.pattern=e,this.chunks=[],!this.pattern.length)return;const p=(h,y)=>{this.chunks.push({pattern:h,alphabet:xt(h),startIndex:y})},m=this.pattern.length;if(m>S){let h=0;const y=m%S,f=m-y;for(;h<f;)p(this.pattern.substr(h,S),h),h+=S;if(y){const b=m-S;p(this.pattern.substr(b),b)}}else p(this.pattern,0)}searchIn(e){const{isCaseSensitive:n,ignoreDiacritics:i,includeMatches:o}=this.options;if(e=n?e:e.toLowerCase(),e=i?j(e):e,this.pattern===e){const f={isMatch:!0,score:0};return o&&(f.indices=[[0,e.length-1]]),f}const{location:r,distance:s,threshold:a,findAllMatches:c,minMatchCharLength:d,ignoreLocation:l}=this.options,p=[];let m=0,h=!1;this.chunks.forEach(({pattern:f,alphabet:b,startIndex:k})=>{const{isMatch:w,score:I,indices:E}=kt(e,f,b,{location:r+k,distance:s,threshold:a,findAllMatches:c,minMatchCharLength:d,includeMatches:o,ignoreLocation:l});w&&(h=!0),m+=I,w&&E&&p.push(...E)});const y={isMatch:h,score:h?m/this.chunks.length:1};return h&&o&&(y.indices=le(p)),y}}class F{constructor(e){this.pattern=e}static isMultiMatch(e){return ve(e,this.multiRegex)}static isSingleMatch(e){return ve(e,this.singleRegex)}search(e){return{isMatch:!1,score:1}}}function ve(t,e){const n=t.match(e);return n?n[1]:null}class Pt extends F{constructor(e){super(e)}static get type(){return"exact"}static get multiRegex(){return/^="(.*)"$/}static get singleRegex(){return/^=(.*)$/}search(e){const n=e===this.pattern;return{isMatch:n,score:n?0:1,indices:[0,this.pattern.length-1]}}}class It extends F{constructor(e){super(e)}static get type(){return"inverse-exact"}static get multiRegex(){return/^!"(.*)"$/}static get singleRegex(){return/^!(.*)$/}search(e){const i=e.indexOf(this.pattern)===-1;return{isMatch:i,score:i?0:1,indices:[0,e.length-1]}}}class Ct extends F{constructor(e){super(e)}static get type(){return"prefix-exact"}static get multiRegex(){return/^\^"(.*)"$/}static get singleRegex(){return/^\^(.*)$/}search(e){const n=e.startsWith(this.pattern);return{isMatch:n,score:n?0:1,indices:[0,this.pattern.length-1]}}}class Rt extends F{constructor(e){super(e)}static get type(){return"inverse-prefix-exact"}static get multiRegex(){return/^!\^"(.*)"$/}static get singleRegex(){return/^!\^(.*)$/}search(e){const n=!e.startsWith(this.pattern);return{isMatch:n,score:n?0:1,indices:[0,e.length-1]}}}class At extends F{constructor(e){super(e)}static get type(){return"suffix-exact"}static get multiRegex(){return/^"(.*)"\$$/}static get singleRegex(){return/^(.*)\$$/}search(e){const n=e.endsWith(this.pattern);return{isMatch:n,score:n?0:1,indices:[e.length-this.pattern.length,e.length-1]}}}class Dt extends F{constructor(e){super(e)}static get type(){return"inverse-suffix-exact"}static get multiRegex(){return/^!"(.*)"\$$/}static get singleRegex(){return/^!(.*)\$$/}search(e){const n=!e.endsWith(this.pattern);return{isMatch:n,score:n?0:1,indices:[0,e.length-1]}}}class Oe extends F{constructor(e,{location:n=g.location,threshold:i=g.threshold,distance:o=g.distance,includeMatches:r=g.includeMatches,findAllMatches:s=g.findAllMatches,minMatchCharLength:a=g.minMatchCharLength,isCaseSensitive:c=g.isCaseSensitive,ignoreDiacritics:d=g.ignoreDiacritics,ignoreLocation:l=g.ignoreLocation}={}){super(e),this._bitapSearch=new ce(e,{location:n,threshold:i,distance:o,includeMatches:r,findAllMatches:s,minMatchCharLength:a,isCaseSensitive:c,ignoreDiacritics:d,ignoreLocation:l})}static get type(){return"fuzzy"}static get multiRegex(){return/^"(.*)"$/}static get singleRegex(){return/^(.*)$/}search(e){return this._bitapSearch.searchIn(e)}}class Le extends F{constructor(e){super(e)}static get type(){return"include"}static get multiRegex(){return/^'"(.*)"$/}static get singleRegex(){return/^'(.*)$/}search(e){let n=0,i;const o=[],r=this.pattern.length;for(;(i=e.indexOf(this.pattern,n))>-1;)n=i+r,o.push([i,n-1]);const s=!!o.length;return{isMatch:s,score:s?0:1,indices:o}}}const Z=[Pt,Le,Ct,Rt,Dt,At,It,Oe],we=Z.length,Mt="\0",_t="|";function Ft(t){const e=[],n=t.length;let i=0;for(;i<n;){for(;i<n&&t[i]===" ";)i++;if(i>=n)break;let o=i;for(;o<n&&t[o]!==" "&&t[o]!=='"';)o++;if(o<n&&t[o]==='"'){for(o++;o<n;){if(t[o]==='"'){const r=o+1;if(r>=n||t[r]===" "){o++;break}if(t[r]==="$"&&(r+1>=n||t[r+1]===" ")){o+=2;break}}o++}e.push(t.substring(i,o)),i=o}else{for(;o<n&&t[o]!==" ";)o++;e.push(t.substring(i,o)),i=o}}return e}function Nt(t,e={}){return t.replace(/\\\|/g,Mt).split(_t).map(i=>{const o=i.replace(/\u0000/g,"|"),r=Ft(o.trim()).filter(a=>a&&!!a.trim()),s=[];for(let a=0,c=r.length;a<c;a+=1){const d=r[a];let l=!1,p=-1;for(;!l&&++p<we;){const m=Z[p],h=m.isMultiMatch(d);h&&(s.push(new m(h,e)),l=!0)}if(!l)for(p=-1;++p<we;){const m=Z[p],h=m.isSingleMatch(d);if(h){s.push(new m(h,e));break}}}return s})}const Et=new Set([Oe.type,Le.type]);class St{constructor(e,{isCaseSensitive:n=g.isCaseSensitive,ignoreDiacritics:i=g.ignoreDiacritics,includeMatches:o=g.includeMatches,minMatchCharLength:r=g.minMatchCharLength,ignoreLocation:s=g.ignoreLocation,findAllMatches:a=g.findAllMatches,location:c=g.location,threshold:d=g.threshold,distance:l=g.distance}={}){this.query=null,this.options={isCaseSensitive:n,ignoreDiacritics:i,includeMatches:o,minMatchCharLength:r,findAllMatches:a,ignoreLocation:s,location:c,threshold:d,distance:l},e=n?e:e.toLowerCase(),e=i?j(e):e,this.pattern=e,this.query=Nt(this.pattern,this.options)}static condition(e,n){return n.useExtendedSearch}searchIn(e){const n=this.query;if(!n)return{isMatch:!1,score:1};const{includeMatches:i,isCaseSensitive:o,ignoreDiacritics:r}=this.options;e=o?e:e.toLowerCase(),e=r?j(e):e;let s=0;const a=[];let c=0,d=!1;for(let l=0,p=n.length;l<p;l+=1){const m=n[l];a.length=0,s=0,d=!1;for(let h=0,y=m.length;h<y;h+=1){const f=m[h],{isMatch:b,indices:k,score:w}=f.search(e);if(b){s+=1,c+=w;const I=f.constructor.type;I.startsWith("inverse")&&(d=!0),i&&(Et.has(I)?a.push(...k):a.push(k))}else{c=0,s=0,a.length=0,d=!1;break}}if(s){const h={isMatch:!0,score:c/s};return d&&(h.hasInverse=!0),i&&(h.indices=le(a)),h}}return{isMatch:!1,score:1}}}const X=[];function de(...t){X.push(...t)}function U(t,e){for(let n=0,i=X.length;n<i;n+=1){const o=X[n];if(o.condition(t,e))return new o(t,e)}return new ce(t,e)}const G={AND:"$and",OR:"$or"},ee={PATH:"$path",PATTERN:"$val"},ne=t=>!!(t[G.AND]||t[G.OR]),Ot=t=>!!t[ee.PATH],Lt=t=>!_(t)&&_e(t)&&!ne(t),ke=t=>({[G.AND]:Object.keys(t).map(e=>({[e]:t[e]}))});function Be(t,e,{auto:n=!0}={}){const i=o=>{if(x(o)){const c={keyId:null,pattern:o};return n&&(c.searcher=U(o,e)),c}const r=Object.keys(o),s=Ot(o);if(!s&&r.length>1&&!ne(o))return i(ke(o));if(Lt(o)){const c=s?o[ee.PATH]:r[0],d=s?o[ee.PATTERN]:o[c];if(!x(d))throw new Error(at(c));const l={keyId:J(c),pattern:d};return n&&(l.searcher=U(d,e)),l}const a={children:[],operator:r[0]};return r.forEach(c=>{const d=o[c];_(d)&&d.forEach(l=>{a.children.push(i(l))})}),a};return ne(t)||(t=ke(t)),i(t)}function te(t,{ignoreFieldNorm:e=g.ignoreFieldNorm}){let n=1;return t.forEach(({key:i,norm:o,score:r})=>{const s=i?i.weight:null;n*=Math.pow(r===0&&s?Number.EPSILON:r,(s||1)*(e?1:o))}),n}function Bt(t,{ignoreFieldNorm:e=g.ignoreFieldNorm}){t.forEach(n=>{n.score=te(n.matches,{ignoreFieldNorm:e})})}class jt{constructor(e){this.limit=e,this.heap=[]}get size(){return this.heap.length}shouldInsert(e){return this.size<this.limit||e<this.heap[0].score}insert(e){this.size<this.limit?(this.heap.push(e),this._bubbleUp(this.size-1)):e.score<this.heap[0].score&&(this.heap[0]=e,this._sinkDown(0))}extractSorted(e){return this.heap.sort(e)}_bubbleUp(e){const n=this.heap;for(;e>0;){const i=e-1>>1;if(n[e].score<=n[i].score)break;const o=n[e];n[e]=n[i],n[i]=o,e=i}}_sinkDown(e){const n=this.heap,i=n.length;let o=e;do{e=o;const r=2*e+1,s=2*e+2;if(r<i&&n[r].score>n[o].score&&(o=r),s<i&&n[s].score>n[o].score&&(o=s),o!==e){const a=n[e];n[e]=n[o],n[o]=a}}while(o!==e)}}function Vt(t,e){const n=t.matches;e.matches=[],P(n)&&n.forEach(i=>{if(!P(i.indices)||!i.indices.length)return;const{indices:o,value:r}=i,s={indices:o,value:r};i.key&&(s.key=i.key.src),i.idx>-1&&(s.refIndex=i.idx),e.matches.push(s)})}function qt(t,e){e.score=t.score}function zt(t,e,{includeMatches:n=g.includeMatches,includeScore:i=g.includeScore}={}){const o=[];return n&&o.push(Vt),i&&o.push(qt),t.map(r=>{const{idx:s}=r,a={item:e[s],refIndex:s};return o.length&&o.forEach(c=>{c(r,a)}),a})}const Wt=/\b\w+\b/g;function oe({isCaseSensitive:t=!1,ignoreDiacritics:e=!1}={}){return{tokenize(n){return t||(n=n.toLowerCase()),e&&(n=j(n)),n.match(Wt)||[]}}}function Ut(t,e,n){const i=new Map,o=new Map;let r=0;function s(a,c,d,l){const p=n.tokenize(a);if(!p.length)return;r++;const m=new Map;for(const h of p)m.set(h,(m.get(h)||0)+1);for(const[h,y]of m){const f={docIdx:c,keyIdx:d,subIdx:l,tf:y};let b=i.get(h);b||(b=[],i.set(h,b)),b.push(f),o.set(h,(o.get(h)||0)+1)}}for(const a of t){const{i:c,v:d,$:l}=a;if(d!==void 0){s(d,c,-1,-1);continue}if(l)for(let p=0;p<e;p++){const m=l[p];if(m)if(Array.isArray(m))for(const h of m)s(h.v,c,p,h.i??-1);else s(m.v,c,p,-1)}}return{terms:i,fieldCount:r,df:o}}function Gt(t,e,n,i){const{i:o,v:r,$:s}=e;function a(c,d,l){const p=i.tokenize(c);if(!p.length)return;t.fieldCount++;const m=new Map;for(const h of p)m.set(h,(m.get(h)||0)+1);for(const[h,y]of m){const f={docIdx:o,keyIdx:d,subIdx:l,tf:y};let b=t.terms.get(h);b||(b=[],t.terms.set(h,b)),b.push(f),t.df.set(h,(t.df.get(h)||0)+1)}}if(r!==void 0){a(r,-1,-1);return}if(s)for(let c=0;c<n;c++){const d=s[c];if(d)if(Array.isArray(d))for(const l of d)a(l.v,c,l.i??-1);else a(d.v,c,-1)}}function xe(t,e){for(const[n,i]of t.terms){const o=i.filter(s=>s.docIdx!==e),r=i.length-o.length;r>0&&(t.fieldCount-=r,t.df.set(n,(t.df.get(n)||0)-r),o.length===0?(t.terms.delete(n),t.df.delete(n)):t.terms.set(n,o))}}class N{constructor(e,n,i){this.options={...g,...n},this.options.useExtendedSearch,this.options.useTokenSearch,this._keyStore=new ut(this.options.keys),this._docs=e,this._myIndex=null,this._invertedIndex=null,this.setCollection(e,i),this._lastQuery=null,this._lastSearcher=null}_getSearcher(e){if(this._lastQuery===e)return this._lastSearcher;const n=this._invertedIndex?{...this.options,_invertedIndex:this._invertedIndex}:this.options,i=U(e,n);return this._lastQuery=e,this._lastSearcher=i,i}setCollection(e,n){if(this._docs=e,n&&!(n instanceof ae))throw new Error(st);if(this._myIndex=n||Ee(this.options.keys,this._docs,{getFn:this.options.getFn,fieldNormWeight:this.options.fieldNormWeight}),this.options.useTokenSearch){const i=oe({isCaseSensitive:this.options.isCaseSensitive,ignoreDiacritics:this.options.ignoreDiacritics});this._invertedIndex=Ut(this._myIndex.records,this._myIndex.keys.length,i)}}add(e){if(P(e)&&(this._docs.push(e),this._myIndex.add(e),this._invertedIndex)){const n=this._myIndex.records[this._myIndex.records.length-1],i=oe({isCaseSensitive:this.options.isCaseSensitive,ignoreDiacritics:this.options.ignoreDiacritics});Gt(this._invertedIndex,n,this._myIndex.keys.length,i)}}remove(e=()=>!1){const n=[],i=[];for(let o=0,r=this._docs.length;o<r;o+=1)e(this._docs[o],o)&&(n.push(this._docs[o]),i.push(o));if(i.length){if(this._invertedIndex)for(const o of i)xe(this._invertedIndex,o);for(let o=i.length-1;o>=0;o-=1)this._docs.splice(i[o],1);this._myIndex.removeAll(i)}return n}removeAt(e){this._invertedIndex&&xe(this._invertedIndex,e);const n=this._docs.splice(e,1)[0];return this._myIndex.removeAt(e),n}getIndex(){return this._myIndex}search(e,n){const{limit:i=-1}=n||{},{includeMatches:o,includeScore:r,shouldSort:s,sortFn:a,ignoreFieldNorm:c}=this.options;if(x(e)&&!e.trim()){let p=this._docs.map((m,h)=>({item:m,refIndex:h}));return W(i)&&i>-1&&(p=p.slice(0,i)),p}const d=W(i)&&i>0&&x(e);let l;if(d){const p=new jt(i);x(this._docs[0])?this._searchStringList(e,{heap:p,ignoreFieldNorm:c}):this._searchObjectList(e,{heap:p,ignoreFieldNorm:c}),l=p.extractSorted(a)}else l=x(e)?x(this._docs[0])?this._searchStringList(e):this._searchObjectList(e):this._searchLogical(e),Bt(l,{ignoreFieldNorm:c}),s&&l.sort(a),W(i)&&i>-1&&(l=l.slice(0,i));return zt(l,this._docs,{includeMatches:o,includeScore:r})}_searchStringList(e,{heap:n,ignoreFieldNorm:i}={}){const o=this._getSearcher(e),{records:r}=this._myIndex,s=n?null:[];return r.forEach(({v:a,i:c,n:d})=>{if(!P(a))return;const{isMatch:l,score:p,indices:m}=o.searchIn(a);if(l){const h={item:a,idx:c,matches:[{score:p,value:a,norm:d,indices:m}]};n?(h.score=te(h.matches,{ignoreFieldNorm:i}),n.shouldInsert(h.score)&&n.insert(h)):s.push(h)}}),s}_searchLogical(e){const n=Be(e,this.options),i=(a,c,d)=>{if(!("children"in a)){const{keyId:h,searcher:y}=a;let f;return h===null?(f=[],this._myIndex.keys.forEach((b,k)=>{f.push(...this._findMatches({key:b,value:c[k],searcher:y}))})):f=this._findMatches({key:this._keyStore.get(h),value:this._myIndex.getValueForItemAtKeyId(c,h),searcher:y}),f&&f.length?[{idx:d,item:c,matches:f}]:[]}const{children:l,operator:p}=a,m=[];for(let h=0,y=l.length;h<y;h+=1){const f=l[h],b=i(f,c,d);if(b.length)m.push(...b);else if(p===G.AND)return[]}return m},o=this._myIndex.records,r=new Map,s=[];return o.forEach(({$:a,i:c})=>{if(P(a)){const d=i(n,a,c);d.length&&(r.has(c)||(r.set(c,{idx:c,item:a,matches:[]}),s.push(r.get(c))),d.forEach(({matches:l})=>{r.get(c).matches.push(...l)}))}}),s}_searchObjectList(e,{heap:n,ignoreFieldNorm:i}={}){const o=this._getSearcher(e),{keys:r,records:s}=this._myIndex,a=n?null:[];return s.forEach(({$:c,i:d})=>{if(!P(c))return;const l=[];let p=!1,m=!1;if(r.forEach((h,y)=>{const f=this._findMatches({key:h,value:c[y],searcher:o});f.length?(l.push(...f),f[0].hasInverse&&(m=!0)):p=!0}),!(m&&p)&&l.length){const h={idx:d,item:c,matches:l};n?(h.score=te(h.matches,{ignoreFieldNorm:i}),n.shouldInsert(h.score)&&n.insert(h)):a.push(h)}}),a}_findMatches({key:e,value:n,searcher:i}){if(!P(n))return[];const o=[];if(_(n))n.forEach(({v:r,i:s,n:a})=>{if(!P(r))return;const{isMatch:c,score:d,indices:l,hasInverse:p}=i.searchIn(r);c&&o.push({score:d,key:e,value:r,idx:s,norm:a,indices:l,hasInverse:p})});else{const{v:r,n:s}=n,{isMatch:a,score:c,indices:d,hasInverse:l}=i.searchIn(r);a&&o.push({score:c,key:e,value:r,norm:s,indices:d,hasInverse:l})}return o}}class Ht{static condition(e,n){return n.useTokenSearch}constructor(e,n){this.options=n,this.analyzer=oe({isCaseSensitive:n.isCaseSensitive,ignoreDiacritics:n.ignoreDiacritics});const i=this.analyzer.tokenize(e),o=n._invertedIndex,{df:r,fieldCount:s}=o;this.termSearchers=[],this.idfWeights=[];for(const a of i){this.termSearchers.push(new ce(a,{location:n.location,threshold:n.threshold,distance:n.distance,includeMatches:n.includeMatches,findAllMatches:n.findAllMatches,minMatchCharLength:n.minMatchCharLength,isCaseSensitive:n.isCaseSensitive,ignoreDiacritics:n.ignoreDiacritics,ignoreLocation:!0}));const c=r.get(a)||0,d=Math.log(1+(s-c+.5)/(c+.5));this.idfWeights.push(d)}}searchIn(e){if(!this.termSearchers.length)return{isMatch:!1,score:1};const n=[];let i=0,o=0,r=0;for(let c=0;c<this.termSearchers.length;c++){const d=this.termSearchers[c].searchIn(e),l=this.idfWeights[c];o+=l,d.isMatch&&(r++,i+=l*(1-d.score),d.indices&&n.push(...d.indices))}if(r===0)return{isMatch:!1,score:1};const s=o>0?1-i/o:0,a={isMatch:!0,score:Math.max(.001,s)};return this.options.includeMatches&&n.length&&(a.indices=le(n)),a}}N.version="7.3.0";N.createIndex=Ee;N.parseIndex=vt;N.config=g;N.match=function(t,e,n){return U(t,{...g,...n}).searchIn(e)};N.parseQuery=Be;de(St);de(Ht);N.use=function(...t){t.forEach(e=>de(e))};function Te(t,e,n){const i=Math.max(0,e),o=Math.min(t.length,n),r=t.slice(i,o).trim();return`${i>0?"…":""}${r}${o<t.length?"…":""}`}function Pe(t,e){const n=e?.find(r=>r.key==="content"&&r.indices.length>0);if(!n)return Te(t,0,140);const[i,o]=n.indices[0];return Te(t,i-60,o+90)}function $t(t,e){const n=new Map(se.map(o=>[o.to,{codeSnippetCount:o.codeSnippetCount,headingCount:o.headings.length}])),i=new Map;for(const o of t){const r=n.get(o.to)??{codeSnippetCount:0,headingCount:0},s=i.get(o.to)??{codeSnippetCount:r.codeSnippetCount,headingCount:r.headingCount,items:[],pagePreview:void 0,pageScore:Number.POSITIVE_INFINITY,score:o.score,section:o.section,title:o.title,to:o.to};s.score=Math.min(s.score,o.score),o.heading?s.items.some(a=>a.id===o.id)||s.items.push(o):(!s.pagePreview||o.score<s.pageScore)&&(s.pagePreview=o.preview,s.pageScore=o.score),i.set(o.to,s)}return[...i.values()].sort((o,r)=>o.score-r.score).slice(0,e?6:8).map(o=>({...o,items:o.items.sort((r,s)=>r.score-s.score).slice(0,e?4:2)}))}function Ie(){const[t,e]=v.useState(!1),[n,i]=v.useState(""),o=v.useRef(null),r=v.useMemo(()=>new N(tt,{keys:[{name:"title",weight:.35},{name:"heading",weight:.3},{name:"section",weight:.1},{name:"content",weight:.25}],threshold:.34,ignoreLocation:!0,minMatchCharLength:2,includeMatches:!0,includeScore:!0}),[]),s=n.trim(),a=v.useMemo(()=>s?r.search(s).slice(0,24).map(d=>({...d.item,preview:Pe(d.item.content,d.matches),score:d.score??0})):se.slice(0,8).map(d=>({content:d.content,id:`${d.to}#page`,preview:Pe(d.content),score:0,section:d.section,title:d.title,to:d.to})),[r,s]),c=v.useMemo(()=>$t(a,!!s),[s,a]);return v.useEffect(()=>{const d=l=>{(l.metaKey||l.ctrlKey)&&l.key==="k"&&(l.preventDefault(),e(!0)),l.key==="Escape"&&e(!1)};return window.addEventListener("keydown",d),()=>window.removeEventListener("keydown",d)},[]),v.useEffect(()=>{t&&setTimeout(()=>o.current?.focus(),50)},[t]),u.jsxs(u.Fragment,{children:[u.jsxs("button",{onClick:()=>e(!0),className:"inline-flex h-10 w-full max-w-sm items-center gap-3 rounded-xl border border-border/80 bg-background/90 px-3.5 text-sm text-muted-foreground shadow-sm transition hover:border-border hover:bg-background hover:text-foreground",children:[u.jsx(fe,{className:"h-4 w-4 shrink-0"}),u.jsx("span",{className:"flex-1 text-left",children:"Search documentation..."}),u.jsx("kbd",{className:"hidden rounded-md border border-border bg-muted px-1.5 py-0.5 text-[10px] text-muted-foreground sm:inline",children:"⌘ K"})]}),t&&u.jsx("div",{className:"fixed inset-0 z-50 flex items-start justify-center bg-slate-950/22 px-4 pt-18 backdrop-blur-[3px] sm:pt-24",onClick:()=>e(!1),children:u.jsxs("div",{onClick:d=>d.stopPropagation(),className:"w-full max-w-3xl overflow-hidden rounded-[1.35rem] border border-border/80 bg-background/95 shadow-[0_30px_90px_-38px_rgba(15,23,42,0.55)]",children:[u.jsxs("div",{className:"flex items-center gap-3 border-b border-border/70 px-4 py-3.5 sm:px-5",children:[u.jsx(fe,{className:"h-4 w-4 shrink-0 text-muted-foreground"}),u.jsx("input",{ref:o,value:n,onChange:d=>i(d.target.value),placeholder:"Search the docs...",className:"flex-1 bg-transparent text-[15px] text-foreground outline-none placeholder:text-muted-foreground"}),u.jsx("button",{onClick:()=>e(!1),className:"rounded-md p-1 text-muted-foreground transition hover:bg-accent/70 hover:text-foreground","aria-label":"Close search",children:u.jsx(Re,{className:"h-4 w-4"})})]}),u.jsx("div",{className:"border-b border-border/60 px-4 py-2 text-[11px] font-medium tracking-[0.18em] text-muted-foreground uppercase sm:px-5",children:s?"Search Results":"Browse Docs"}),u.jsx("div",{className:"max-h-[34rem] overflow-y-auto px-2 py-2 sm:px-3",children:c.length===0?u.jsxs("div",{className:"px-4 py-10 text-center text-sm text-muted-foreground",children:['No results for "',s,'"']}):u.jsx("div",{className:"divide-y divide-border/60",children:c.map(d=>u.jsxs("section",{className:"px-2 py-2.5",children:[u.jsx(M,{to:d.to,onClick:()=>e(!1),className:"group block rounded-2xl px-3 py-3 transition hover:bg-accent/45",children:u.jsxs("div",{className:"flex items-start gap-3",children:[u.jsx("div",{className:"mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-muted text-muted-foreground",children:u.jsx(gn,{className:"h-4 w-4"})}),u.jsxs("div",{className:"min-w-0 flex-1",children:[u.jsx("div",{className:"truncate text-[11px] font-medium tracking-[0.18em] text-muted-foreground uppercase",children:d.section}),u.jsx("div",{className:"mt-1 truncate text-[15px] font-semibold text-foreground",children:d.title}),u.jsxs("div",{className:"mt-2 flex flex-wrap gap-2",children:[d.headingCount>0&&u.jsx(Ce,{label:"Main Topics"}),d.codeSnippetCount>0&&u.jsx(Ce,{label:"Code Snippets"})]})]}),u.jsx(ln,{className:"mt-1 h-4 w-4 shrink-0 text-muted-foreground transition group-hover:text-foreground"})]})}),d.items.length>0&&u.jsxs("div",{className:"mt-1 space-y-1 pl-12",children:[u.jsx("div",{className:"px-3 pt-1 text-[11px] font-medium tracking-[0.18em] text-muted-foreground uppercase",children:"Main Topics"}),d.items.map(l=>u.jsxs(M,{to:l.to,hash:l.anchor?()=>l.anchor:void 0,onClick:()=>e(!1),className:"group flex gap-3 rounded-xl px-3 py-2.5 transition hover:bg-accent/35",children:[u.jsx("div",{className:"flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-muted/70 text-muted-foreground transition group-hover:bg-background",children:l.headingLevel===3?u.jsx(pn,{className:"h-3.5 w-3.5"}):u.jsx(yn,{className:"h-3.5 w-3.5"})}),u.jsxs("div",{className:"min-w-0 flex-1",children:[u.jsx("div",{className:"truncate text-sm font-medium text-foreground",children:l.heading}),u.jsx("p",{className:"mt-1 text-[13px] leading-5 text-muted-foreground",style:{display:"-webkit-box",WebkitBoxOrient:"vertical",WebkitLineClamp:2,overflow:"hidden"},children:l.preview})]})]},l.id))]})]},d.to))})})]})})]})}function Ce({label:t}){return u.jsx("span",{className:"rounded-full border border-border/70 bg-muted/60 px-2.5 py-1 text-[11px] font-medium tracking-[0.08em] text-muted-foreground uppercase",children:t})}var H="Collapsible",[Kt]=rn(H),[Yt,ue]=Kt(H),je=v.forwardRef((t,e)=>{const{__scopeCollapsible:n,open:i,defaultOpen:o,disabled:r,onOpenChange:s,...a}=t,[c,d]=Xe({prop:i,defaultProp:o??!1,onChange:s,caller:H});return u.jsx(Yt,{scope:n,disabled:r,contentId:en(),open:c,onOpenToggle:v.useCallback(()=>d(l=>!l),[d]),children:u.jsx(re.div,{"data-state":pe(c),"data-disabled":r?"":void 0,...a,ref:e})})});je.displayName=H;var Ve="CollapsibleTrigger",qe=v.forwardRef((t,e)=>{const{__scopeCollapsible:n,...i}=t,o=ue(Ve,n);return u.jsx(re.button,{type:"button","aria-controls":o.contentId,"aria-expanded":o.open||!1,"data-state":pe(o.open),"data-disabled":o.disabled?"":void 0,disabled:o.disabled,...i,ref:e,onClick:nn(t.onClick,o.onOpenToggle)})});qe.displayName=Ve;var he="CollapsibleContent",ze=v.forwardRef((t,e)=>{const{forceMount:n,...i}=t,o=ue(he,t.__scopeCollapsible);return u.jsx(tn,{present:n||o.open,children:({present:r})=>u.jsx(Qt,{...i,ref:e,present:r})})});ze.displayName=he;var Qt=v.forwardRef((t,e)=>{const{__scopeCollapsible:n,present:i,children:o,...r}=t,s=ue(he,n),[a,c]=v.useState(i),d=v.useRef(null),l=Qe(e,d),p=v.useRef(0),m=p.current,h=v.useRef(0),y=h.current,f=s.open||a,b=v.useRef(f),k=v.useRef(void 0);return v.useEffect(()=>{const w=requestAnimationFrame(()=>b.current=!1);return()=>cancelAnimationFrame(w)},[]),on(()=>{const w=d.current;if(w){k.current=k.current||{transitionDuration:w.style.transitionDuration,animationName:w.style.animationName},w.style.transitionDuration="0s",w.style.animationName="none";const I=w.getBoundingClientRect();p.current=I.height,h.current=I.width,b.current||(w.style.transitionDuration=k.current.transitionDuration,w.style.animationName=k.current.animationName),c(i)}},[s.open,i]),u.jsx(re.div,{"data-state":pe(s.open),"data-disabled":s.disabled?"":void 0,id:s.contentId,hidden:!f,...r,ref:l,style:{"--radix-collapsible-content-height":m?`${m}px`:void 0,"--radix-collapsible-content-width":y?`${y}px`:void 0,...t.style},children:f&&o})});function pe(t){return t?"open":"closed"}var Jt=je;const Zt=Jt,Xt=qe,eo=ze;function no(){const t=sn(),[e,n]=v.useState(!1),i=L.findIndex(a=>a.to===t.pathname),o=i>0?L[i-1]:null,r=i>=0&&i<L.length-1?L[i+1]:null,s=L[i];return v.useEffect(()=>{const a=document.querySelectorAll(".prose-docs h2, .prose-docs h3"),c=new Map;for(const d of a){const l=d.textContent?.trim();if(!l)continue;const p=Me(l)||"section",m=c.get(p)??0;c.set(p,m+1),d.id=m===0?p:`${p}-${m+1}`}},[t.pathname]),u.jsxs("div",{className:"min-h-screen bg-background",children:[u.jsx("header",{className:"sticky top-0 z-40 border-b border-border bg-background/80 backdrop-blur",children:u.jsxs("div",{className:"mx-auto flex h-14 max-w-[1400px] items-center gap-4 px-4 lg:px-6",children:[u.jsx("button",{className:"lg:hidden",onClick:()=>n(a=>!a),"aria-label":"Toggle menu",children:e?u.jsx(Re,{className:"h-5 w-5"}):u.jsx(vn,{className:"h-5 w-5"})}),u.jsxs(M,{to:"/",className:"flex items-center gap-2",children:[u.jsx("img",{src:Ye,alt:"PID Pilot",className:"h-8 w-8"}),u.jsx("span",{className:"font-display text-lg font-semibold tracking-tight",children:"PID Pilot"}),u.jsx("span",{className:"hidden rounded-md border border-border bg-muted px-1.5 py-0.5 font-mono text-[10px] text-muted-foreground sm:inline",children:"docs"})]}),u.jsx("div",{className:"flex-1"}),u.jsxs("nav",{className:"hidden items-center gap-4 sm:flex",children:[u.jsx(M,{to:"/guide",className:ie("text-sm font-medium transition",t.pathname.startsWith("/guide")?"text-foreground":"text-muted-foreground hover:text-foreground"),children:"Docs"}),u.jsx(M,{to:"/tuner",className:"text-sm font-medium text-muted-foreground transition hover:text-foreground",children:"Tuner"})]}),u.jsx("div",{className:"hidden md:block",children:u.jsx(Ie,{})}),u.jsx(Je,{className:"h-9 w-9"})]})}),u.jsxs("div",{className:"mx-auto flex max-w-[1400px] gap-4 px-4 sm:gap-6 lg:px-6 xl:gap-8",children:[u.jsxs("aside",{className:`${e?"block":"hidden"} fixed inset-x-0 top-14 z-30 max-h-[calc(100vh-3.5rem)] overflow-y-auto border-b border-border bg-sidebar px-4 py-3 shadow-sm lg:sticky lg:top-14 lg:block lg:max-h-[calc(100vh-3.5rem)] lg:w-64 lg:flex-shrink-0 lg:border-0 lg:bg-transparent lg:px-0 lg:py-6 lg:shadow-none`,children:[u.jsx("div",{className:"mb-4 lg:hidden",children:u.jsx(Ie,{})}),u.jsx("nav",{className:"space-y-4 pb-8 lg:space-y-5 lg:pb-12",children:De.map(a=>u.jsxs("div",{children:[u.jsx("h4",{className:"mb-2 px-2 font-display text-xs font-semibold uppercase tracking-wider text-muted-foreground",children:a.title}),u.jsx("ul",{className:"space-y-0.5",children:a.links.map(c=>Ae(c)?u.jsx(to,{title:c.title,links:c.links,pathname:t.pathname,onNavigate:()=>n(!1)},`${a.title}-${c.title}`):u.jsx(We,{link:c,active:t.pathname===c.to,onNavigate:()=>n(!1)},c.to))})]},a.title))})]}),u.jsxs("main",{className:"min-w-0 flex-1 py-6 sm:py-8 lg:py-10 xl:py-12",children:[s&&u.jsxs("div",{className:"mb-4 flex flex-wrap items-center gap-1.5 text-xs text-muted-foreground",children:[u.jsx("span",{children:"Docs"}),u.jsx(ge,{className:"h-3 w-3"}),u.jsx("span",{children:s.section}),u.jsx(ge,{className:"h-3 w-3"}),u.jsx("span",{className:"text-foreground",children:s.title})]}),u.jsx("article",{className:"prose-docs",children:u.jsx(Ke,{})}),u.jsxs("div",{className:"mt-16 grid gap-3 border-t border-border pt-8 sm:grid-cols-2",children:[o?u.jsxs(M,{to:o.to,className:"group rounded-lg border border-border p-4 transition hover:border-brand/50 hover:bg-accent/30",children:[u.jsx("div",{className:"text-xs text-muted-foreground",children:"← Previous"}),u.jsx("div",{className:"mt-1 font-medium text-foreground group-hover:text-brand",children:o.title})]}):u.jsx("div",{}),r&&u.jsxs(M,{to:r.to,className:"group rounded-lg border border-border p-4 text-right transition hover:border-brand/50 hover:bg-accent/30 sm:col-start-2",children:[u.jsx("div",{className:"text-xs text-muted-foreground",children:"Next →"}),u.jsx("div",{className:"mt-1 font-medium text-foreground group-hover:text-brand",children:r.title})]})]})]})]}),u.jsx(Ze,{})]})}function We({link:t,active:e,onNavigate:n,compact:i=!1}){return u.jsx("li",{children:u.jsx(M,{to:t.to,onClick:n,className:ie("block rounded-md border-l-2 text-sm transition",i?"px-3 py-1.5":"px-3 py-2",e?"border-brand bg-brand-muted font-medium text-brand":"border-transparent text-muted-foreground hover:border-border hover:bg-accent/50 hover:text-foreground"),children:t.title})})}function to({title:t,links:e,pathname:n,onNavigate:i}){const o=e.some(a=>a.to===n),[r,s]=v.useState(o);return v.useEffect(()=>{o&&s(!0)},[o]),u.jsx("li",{children:u.jsxs(Zt,{open:r,onOpenChange:s,children:[u.jsxs(Xt,{className:ie("group flex w-full items-center justify-between rounded-md border border-transparent px-3 py-2 text-left text-sm transition",o?"bg-brand-muted font-medium text-brand":"text-muted-foreground hover:border-border hover:bg-accent/50 hover:text-foreground"),children:[u.jsx("span",{children:t}),u.jsx(dn,{className:"h-4 w-4 transition duration-200 group-data-[state=open]:rotate-180"})]}),u.jsx(eo,{className:"mt-1 space-y-0.5 pl-3",children:u.jsx("ul",{className:"space-y-0.5 border-l border-border/80",children:e.map(a=>u.jsx(We,{link:a,active:n===a.to,onNavigate:i,compact:!0},a.to))})})]})})}const uo=no;export{uo as component};
